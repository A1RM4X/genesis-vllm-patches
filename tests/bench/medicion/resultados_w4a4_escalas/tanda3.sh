...
log "inicio tanda 2: rotaciones grandes + g1024"
for v in densa-g0 had8192-g0 had-g1024; do
  T=sim_${v//-/_}
...
cd /tmp/g115 && python3 sondeos.py --comparar fp16 wush_gate_up sim_had_g256 sim_had_g0 sim_densa_g0 sim_had8192_g0 sim_had_g1024 > $R/comparacion2.txt 2>&1
bajar; docker compose -f $CD/docker-compose.qwen38-27b-noon-w4a8.yml up -d >/dev/null 2>&1
log "fin tanda 2 (queda arriba noon W4A8 + PN125)"
