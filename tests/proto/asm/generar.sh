...
GEN=${GEN:-/root/.cache/genesis/marlin_s16_red/gen}
...
FLAGS="-DTORCH_EXTENSION_NAME=genesis_marlin_s16 -DTORCH_API_INCLUDE_EXTENSION_H
  -I/root/.cache/genesis/marlin_s16_red/gen -I/m/inc
...
cd /root/.cache/genesis/marlin_s16_red/gen
# Solo la unidad con las instanciaciones del kernel W4A8, no el marlin.cu entero (que arrastra torch)
/usr/local/cuda/bin/nvcc $FLAGS -arch=sm_86 -ptx sm80_kernel_s8_u4b8_float16.cu -o /w/tests/proto/asm/marlin_red.ptx
/usr/local/cuda/bin/nvcc $FLAGS -arch=sm_86 -cubin sm80_kernel_s8_u4b8_float16.cu -o /w/tests/proto/asm/marlin_red.cubin
'
