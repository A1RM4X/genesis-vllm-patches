...
for N in (20000, 57000, 100000):
    ...
    T1, T2 = [], []
    for _ in range(7):
        T1.append(medir(lambda: k1.lanzar((NCH, 2), args, shared=P.SH_H), n=20))
        T2.append(medir(lambda: k2.lanzar((NCH, 2), args, shared=SH2), n=20))
    t1 = sorted(T1)[3]; t2 = sorted(T2)[3]
