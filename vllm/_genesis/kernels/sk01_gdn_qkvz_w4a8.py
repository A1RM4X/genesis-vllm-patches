...
.reqntid 256
{
	...
	.reg .b32 	%r<538>;
	.reg .b64 	%rd<21>;
	.loc	1 106 0                         // sk01_gdn_qkvz_w4a8.py:106:0
$L__func_begin0:
	.loc	1 106 0                         // sk01_gdn_qkvz_w4a8.py:106:0
...
$L__tmp0:
	.loc	1 111 24                        // sk01_gdn_qkvz_w4a8.py:111:24
	mov.u32 	%r51, %ctaid.x;
	ld.param.b64 	%rd14, [_sk01_gdn_qkvz_w4a8_rmsnorm_quant_kernel_param_2];
	.loc	1 112 24                        // sk01_gdn_qkvz_w4a8.py:112:24
	mov.u32 	%r52, %tid.x;
	and.b32 	%r53, %r52, 255;
	...
	or.b32 	%r61, %r60, 4096;
	.loc	1 113 18                        // sk01_gdn_qkvz_w4a8.py:113:18
	setp.lt.s32 	%p1, %r60, %r55;
	setp.lt.s32 	%p2, %r61, %r55;
	.loc	1 114 30                        // sk01_gdn_qkvz_w4a8.py:114:30
	mul.lo.s32 	%r62, %r57, %r51;
	.loc	1 114 24                        // sk01_gdn_qkvz_w4a8.py:114:24
	mad.wide.s32 	%rd16, %r62, 2, %rd12;
	.loc	1 114 42                        // sk01_gdn_qkvz_w4a8.py:114:42
	...
	mov.b32 	%r5, 0;
	.loc	1 114 16                        // sk01_gdn_qkvz_w4a8.py:114:16
	// begin inline asm
	mov.u32 %r1, %r5;
	mov.u32 %r2, %r5;
	mov.u32 %r3, %r5;
	...
	// end inline asm
	.loc	1 114 73                        // sk01_gdn_qkvz_w4a8.py:114:73
	mov.b32 	{%rs1, %rs2}, %r2;
	...
	.loc	1 115 24                        // sk01_gdn_qkvz_w4a8.py:115:24
	add.s64 	%rd5, %rd13, %rd18;
	add.s64 	%rd6, %rd5, 16;
	add.s64 	%rd7, %rd5, 8192;
	add.s64 	%rd8, %rd5, 8208;
	.loc	1 115 16                        // sk01_gdn_qkvz_w4a8.py:115:16
	// begin inline asm
	mov.u32 %r18, %r5;
	mov.u32 %r19, %r5;
	mov.u32 %r20, %r5;
	...
	// end inline asm
	.loc	1 116 32                        // sk01_gdn_qkvz_w4a8.py:116:32
	mul.f32 	%r95, %r66, %r66;
$L__tmp1:
	.loc	2 263 15                        // standard.py:263:15 @[ standard.py:293:36 @[ sk01_gdn_qkvz_w4a8.py:116:28 ] ]
...
$L__tmp2:
	.loc	2 293 36                        // standard.py:293:36 @[ sk01_gdn_qkvz_w4a8.py:116:28 ]
...
$L__tmp19:
	.loc	1 116 45                        // sk01_gdn_qkvz_w4a8.py:116:45
	cvt.rn.f32.s32 	%r147, %r55;
	div.full.f32 	%r148, %r146, %r147;
	.loc	1 116 49                        // sk01_gdn_qkvz_w4a8.py:116:49
	add.f32 	%r149, %r148, 0f358637BD;
	.loc	1 116 21                        // sk01_gdn_qkvz_w4a8.py:116:21
	rsqrt.approx.ftz.f32 	%r150, %r149;
	.loc	1 116 12                        // sk01_gdn_qkvz_w4a8.py:116:12
...
$L__tmp20:
	.loc	2 191 40                        // standard.py:191:40 @[ sk01_gdn_qkvz_w4a8.py:117:29 ]
	bar.sync 	0;
$L__tmp21:
	.loc	1 120 27                        // sk01_gdn_qkvz_w4a8.py:120:27
	mul.lo.s32 	%r183, %r59, %r51;
	.loc	1 120 21                        // sk01_gdn_qkvz_w4a8.py:120:21
	cvt.s64.s32 	%rd19, %r183;
	add.s64 	%rd20, %rd14, %rd19;
	.loc	1 120 39                        // sk01_gdn_qkvz_w4a8.py:120:39
	add.s64 	%rd9, %rd20, %rd17;
	add.s64 	%rd10, %rd9, 4096;
	.loc	1 115 55                        // sk01_gdn_qkvz_w4a8.py:115:55
	...
	abs.f32 	%r231, %r224;
$L__tmp22:
	.loc	2 170 27                        // standard.py:170:27 @[ standard.py:191:40 @[ sk01_gdn_qkvz_w4a8.py:117:29 ] ]
...
$L__tmp42:
	.loc	1 117 49                        // sk01_gdn_qkvz_w4a8.py:117:49
	max.f32 	%r326, %r325, 0f0DA24260;
	mov.b32 	%r327, 0f42FE0000;
	.loc	1 118 22                        // sk01_gdn_qkvz_w4a8.py:118:22
	div.full.f32 	%r328, %r327, %r326;
	.loc	1 118 14                        // sk01_gdn_qkvz_w4a8.py:118:14
	...
	.loc	1 119 29                        // sk01_gdn_qkvz_w4a8.py:119:29
	.loc	1 119 39                        // sk01_gdn_qkvz_w4a8.py:119:39
	...
	.loc	1 119 14                        // sk01_gdn_qkvz_w4a8.py:119:14
	...
	.loc	1 119 49                        // sk01_gdn_qkvz_w4a8.py:119:49
	...
	.loc	1 120 70                        // sk01_gdn_qkvz_w4a8.py:120:70
	...
	.loc	1 120 77                        // sk01_gdn_qkvz_w4a8.py:120:77
	...
	.loc	1 120 85                        // sk01_gdn_qkvz_w4a8.py:120:85
	...
	.loc	1 120 45                        // sk01_gdn_qkvz_w4a8.py:120:45
	// begin inline asm
	...
	.loc	1 121 34                        // sk01_gdn_qkvz_w4a8.py:121:34
	mul.f32 	%r50, %r326, 0f3C010204;
	.loc	1 121 26                        // sk01_gdn_qkvz_w4a8.py:121:26
	or.b32 	%r537, %r54, %r56;
	setp.eq.b32 	%p6, %r537, 0;
	// begin inline asm
	@%p6 st.global.b32 [ %rd11 + 0 ], { %r50 };
	// end inline asm
	.loc	1 121 4                         // sk01_gdn_qkvz_w4a8.py:121:4
	ret;
$L__tmp43:
$L__func_end0:
                                        // -- End function
}
	.file	1 "/home/usuario/Proyectos/genesis-vllm-patches/vllm/_genesis/kernels/sk01_gdn_qkvz_w4a8.py"
...
.b8 115
.b8 0
.b8 2                                   // Abbrev [2] 0x72:0x2b DW_TAG_subprogram
.b8 95                                  // DW_AT_name
.b8 115
.b8 107
.b8 48
...
.b8 0
.b8 1                                   // DW_AT_inline
.b8 3                                   // Abbrev [3] 0x9d:0x79 DW_TAG_subprogram
.b64 $L__func_begin0                    // DW_AT_low_pc
.b64 $L__func_end0                      // DW_AT_high_pc
.b32 114                                // DW_AT_abstract_origin
.b8 4                                   // Abbrev [4] 0xb2:0x32 DW_TAG_inlined_subroutine
.b32 114                                // DW_AT_abstract_origin
...
.b8 5                                   // Abbrev [5] 0xca:0x19 DW_TAG_inlined_subroutine
.b32 114                                // DW_AT_abstract_origin
.b64 $L__tmp1                           // DW_AT_low_pc
...
.b8 4                                   // Abbrev [4] 0xe4:0x31 DW_TAG_inlined_subroutine
.b32 114                                // DW_AT_abstract_origin
...
.b8 6                                   // Abbrev [6] 0xfc:0x18 DW_TAG_inlined_subroutine
.b32 114                                // DW_AT_abstract_origin
...
_PTX_KERNEL = _Nativo(
    'B2/sk01_gdn_qkvz_w4a8.py__rmsnorm_quant',
    _PTX_RMSNORM_QUANT, '_sk01_gdn_qkvz_w4a8_rmsnorm_quant_kernel',
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5, 6],
