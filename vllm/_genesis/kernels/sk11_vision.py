...
# --- quant _sk11_bias_gelu_kernel: 4 variante(s) de PTX embebido ---
...
_QVAR0_0 = _Nativo(
    "sk11_vision/_sk11_bias_gelu_kernel/blk2048",
    _QPTX0_0, "_sk11_bias_gelu_kernel",
    warps=8, shared=0,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 2048},
    div16=[3, 4, 5],
...
// %bb.0:
	ld.param.b64 	%rd7, [_sk11_bias_gelu_kernel_param_0];
	ld.param.b64 	%rd8, [_sk11_bias_gelu_kernel_param_1];
$L__tmp0:
	.loc	1 111 24                        // sk11_vision.py:111:24
	mov.u32 	%r26, %ctaid.x;
	ld.param.b64 	%rd9, [_sk11_bias_gelu_kernel_param_2];
	.loc	1 112 24                        // sk11_vision.py:112:24
	mov.u32 	%r27, %tid.x;
	shl.b32 	%r28, %r27, 3;
	ld.param.b32 	%r29, [_sk11_bias_gelu_kernel_param_3];
	and.b32 	%r30, %r28, 2040;
	ld.param.b32 	%r31, [_sk11_bias_gelu_kernel_param_4];
	or.b32 	%r32, %r30, 2048;
	ld.param.b32 	%r33, [_sk11_bias_gelu_kernel_param_5];
	.loc	1 113 18                        // sk11_vision.py:113:18
	setp.lt.s32 	%p1, %r30, %r29;
	setp.lt.s32 	%p2, %r32, %r29;
	.loc	1 114 30                        // sk11_vision.py:114:30
	mul.lo.s32 	%r34, %r31, %r26;
	.loc	1 114 24                        // sk11_vision.py:114:24
	mad.wide.s32 	%rd10, %r34, 2, %rd7;
	.loc	1 114 42                        // sk11_vision.py:114:42
	...
	// end inline asm
	.loc	1 118 29                        // sk11_vision.py:118:29
	mul.lo.s32 	%r35, %r33, %r26;
	.loc	1 118 23                        // sk11_vision.py:118:23
	mad.wide.s32 	%rd12, %r35, 2, %rd9;
	.loc	1 118 41                        // sk11_vision.py:118:41
	...
	add.f32 	%r41, %r36, %r38;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r42, %r41, 0f3D372713;
	mul.f32 	%r43, %r40, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r44, %r41, %r42;
	mul.f32 	%r45, %r40, %r43;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r46, %r41, %r44, %r41;
	fma.rn.f32 	%r47, %r40, %r45, %r40;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r48, %r46, 0f3F4C422A;
	mul.f32 	%r49, %r47, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r50, %r40, 0f3F000000;
	mul.f32 	%r51, %r41, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r52, %r48, 0fC0000000;
	mul.f32 	%r53, %r49, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r54, %r52, 0f3FB8AA3B;
	ex2.approx.f32 	%r55, %r54;
	mul.f32 	%r56, %r53, 0f3FB8AA3B;
	ex2.approx.f32 	%r57, %r56;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r58, %r55, 0f3F800000;
	add.f32 	%r59, %r57, 0f3F800000;
	mov.b32 	%r60, 0f40000000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r61, %r60, %r58;
	div.full.f32 	%r62, %r60, %r59;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r63, %r61, 0fBF800000;
	add.f32 	%r64, %r62, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r65, %r64, 0f3F800000;
	add.f32 	%r66, %r63, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r67, %r51, %r66;
	mul.f32 	%r68, %r50, %r65;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r18, %r68, %r67;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs5, %rs6}, %r2;
	cvt.f32.bf16 	%r69, %rs5;
	cvt.f32.bf16 	%r70, %rs6;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs7, %rs8}, %r11;
	cvt.f32.bf16 	%r71, %rs7;
	cvt.f32.bf16 	%r72, %rs8;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r73, %r70, %r72;
	add.f32 	%r74, %r69, %r71;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r75, %r74, 0f3D372713;
	mul.f32 	%r76, %r73, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r77, %r74, %r75;
	mul.f32 	%r78, %r73, %r76;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r79, %r74, %r77, %r74;
	fma.rn.f32 	%r80, %r73, %r78, %r73;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r81, %r79, 0f3F4C422A;
	mul.f32 	%r82, %r80, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r83, %r73, 0f3F000000;
	mul.f32 	%r84, %r74, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r85, %r81, 0fC0000000;
	mul.f32 	%r86, %r82, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	...
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r93, %r60, %r91;
	div.full.f32 	%r94, %r60, %r92;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r95, %r93, 0fBF800000;
	add.f32 	%r96, %r94, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r97, %r96, 0f3F800000;
	add.f32 	%r98, %r95, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r99, %r84, %r98;
	mul.f32 	%r100, %r83, %r97;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r19, %r100, %r99;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs9, %rs10}, %r3;
	cvt.f32.bf16 	%r101, %rs9;
	cvt.f32.bf16 	%r102, %rs10;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs11, %rs12}, %r12;
	cvt.f32.bf16 	%r103, %rs11;
	cvt.f32.bf16 	%r104, %rs12;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r105, %r102, %r104;
	add.f32 	%r106, %r101, %r103;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r107, %r106, 0f3D372713;
	mul.f32 	%r108, %r105, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r109, %r106, %r107;
	mul.f32 	%r110, %r105, %r108;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r111, %r106, %r109, %r106;
	fma.rn.f32 	%r112, %r105, %r110, %r105;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r113, %r111, 0f3F4C422A;
	mul.f32 	%r114, %r112, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r115, %r105, 0f3F000000;
	mul.f32 	%r116, %r106, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r117, %r113, 0fC0000000;
	mul.f32 	%r118, %r114, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r119, %r117, 0f3FB8AA3B;
	ex2.approx.f32 	%r120, %r119;
	mul.f32 	%r121, %r118, 0f3FB8AA3B;
	ex2.approx.f32 	%r122, %r121;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r123, %r120, 0f3F800000;
	add.f32 	%r124, %r122, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r125, %r60, %r123;
	div.full.f32 	%r126, %r60, %r124;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r127, %r125, 0fBF800000;
	add.f32 	%r128, %r126, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r129, %r128, 0f3F800000;
	add.f32 	%r130, %r127, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r131, %r116, %r130;
	mul.f32 	%r132, %r115, %r129;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r20, %r132, %r131;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs13, %rs14}, %r4;
	cvt.f32.bf16 	%r133, %rs13;
	cvt.f32.bf16 	%r134, %rs14;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs15, %rs16}, %r13;
	cvt.f32.bf16 	%r135, %rs15;
	cvt.f32.bf16 	%r136, %rs16;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r137, %r134, %r136;
	add.f32 	%r138, %r133, %r135;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r139, %r138, 0f3D372713;
	mul.f32 	%r140, %r137, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r141, %r138, %r139;
	mul.f32 	%r142, %r137, %r140;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r143, %r138, %r141, %r138;
	fma.rn.f32 	%r144, %r137, %r142, %r137;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r145, %r143, 0f3F4C422A;
	mul.f32 	%r146, %r144, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r147, %r137, 0f3F000000;
	mul.f32 	%r148, %r138, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r149, %r145, 0fC0000000;
	mul.f32 	%r150, %r146, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r151, %r149, 0f3FB8AA3B;
	ex2.approx.f32 	%r152, %r151;
	mul.f32 	%r153, %r150, 0f3FB8AA3B;
	ex2.approx.f32 	%r154, %r153;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r155, %r152, 0f3F800000;
	add.f32 	%r156, %r154, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r157, %r60, %r155;
	div.full.f32 	%r158, %r60, %r156;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r159, %r157, 0fBF800000;
	add.f32 	%r160, %r158, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r161, %r160, 0f3F800000;
	add.f32 	%r162, %r159, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r163, %r148, %r162;
	mul.f32 	%r164, %r147, %r161;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r21, %r164, %r163;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs17, %rs18}, %r6;
	cvt.f32.bf16 	%r165, %rs17;
	cvt.f32.bf16 	%r166, %rs18;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs19, %rs20}, %r14;
	cvt.f32.bf16 	%r167, %rs19;
	cvt.f32.bf16 	%r168, %rs20;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r169, %r166, %r168;
	add.f32 	%r170, %r165, %r167;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r171, %r170, 0f3D372713;
	mul.f32 	%r172, %r169, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r173, %r170, %r171;
	mul.f32 	%r174, %r169, %r172;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r175, %r170, %r173, %r170;
	fma.rn.f32 	%r176, %r169, %r174, %r169;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r177, %r175, 0f3F4C422A;
	mul.f32 	%r178, %r176, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r179, %r169, 0f3F000000;
	mul.f32 	%r180, %r170, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r181, %r177, 0fC0000000;
	mul.f32 	%r182, %r178, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r183, %r181, 0f3FB8AA3B;
	ex2.approx.f32 	%r184, %r183;
	mul.f32 	%r185, %r182, 0f3FB8AA3B;
	ex2.approx.f32 	%r186, %r185;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r187, %r184, 0f3F800000;
	add.f32 	%r188, %r186, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r189, %r60, %r187;
	div.full.f32 	%r190, %r60, %r188;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r191, %r189, 0fBF800000;
	add.f32 	%r192, %r190, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r193, %r192, 0f3F800000;
	add.f32 	%r194, %r191, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r195, %r180, %r194;
	mul.f32 	%r196, %r179, %r193;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r22, %r196, %r195;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs21, %rs22}, %r7;
	cvt.f32.bf16 	%r197, %rs21;
	cvt.f32.bf16 	%r198, %rs22;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs23, %rs24}, %r15;
	cvt.f32.bf16 	%r199, %rs23;
	cvt.f32.bf16 	%r200, %rs24;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r201, %r198, %r200;
	add.f32 	%r202, %r197, %r199;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r203, %r202, 0f3D372713;
	mul.f32 	%r204, %r201, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r205, %r202, %r203;
	mul.f32 	%r206, %r201, %r204;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r207, %r202, %r205, %r202;
	fma.rn.f32 	%r208, %r201, %r206, %r201;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r209, %r207, 0f3F4C422A;
	mul.f32 	%r210, %r208, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r211, %r201, 0f3F000000;
	mul.f32 	%r212, %r202, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r213, %r209, 0fC0000000;
	mul.f32 	%r214, %r210, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r215, %r213, 0f3FB8AA3B;
	ex2.approx.f32 	%r216, %r215;
	mul.f32 	%r217, %r214, 0f3FB8AA3B;
	ex2.approx.f32 	%r218, %r217;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r219, %r216, 0f3F800000;
	add.f32 	%r220, %r218, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r221, %r60, %r219;
	div.full.f32 	%r222, %r60, %r220;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r223, %r221, 0fBF800000;
	add.f32 	%r224, %r222, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r225, %r224, 0f3F800000;
	add.f32 	%r226, %r223, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r227, %r212, %r226;
	mul.f32 	%r228, %r211, %r225;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r23, %r228, %r227;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs25, %rs26}, %r8;
	cvt.f32.bf16 	%r229, %rs25;
	cvt.f32.bf16 	%r230, %rs26;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs27, %rs28}, %r16;
	cvt.f32.bf16 	%r231, %rs27;
	cvt.f32.bf16 	%r232, %rs28;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r233, %r230, %r232;
	add.f32 	%r234, %r229, %r231;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r235, %r234, 0f3D372713;
	mul.f32 	%r236, %r233, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r237, %r234, %r235;
	mul.f32 	%r238, %r233, %r236;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r239, %r234, %r237, %r234;
	fma.rn.f32 	%r240, %r233, %r238, %r233;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r241, %r239, 0f3F4C422A;
	mul.f32 	%r242, %r240, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r243, %r233, 0f3F000000;
	mul.f32 	%r244, %r234, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r245, %r241, 0fC0000000;
	mul.f32 	%r246, %r242, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r247, %r245, 0f3FB8AA3B;
	ex2.approx.f32 	%r248, %r247;
	mul.f32 	%r249, %r246, 0f3FB8AA3B;
	ex2.approx.f32 	%r250, %r249;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r251, %r248, 0f3F800000;
	add.f32 	%r252, %r250, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r253, %r60, %r251;
	div.full.f32 	%r254, %r60, %r252;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r255, %r253, 0fBF800000;
	add.f32 	%r256, %r254, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r257, %r256, 0f3F800000;
	add.f32 	%r258, %r255, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r259, %r244, %r258;
	mul.f32 	%r260, %r243, %r257;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r24, %r260, %r259;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs29, %rs30}, %r9;
	cvt.f32.bf16 	%r261, %rs29;
	cvt.f32.bf16 	%r262, %rs30;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs31, %rs32}, %r17;
	cvt.f32.bf16 	%r263, %rs31;
	cvt.f32.bf16 	%r264, %rs32;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r265, %r262, %r264;
	add.f32 	%r266, %r261, %r263;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r267, %r266, 0f3D372713;
	mul.f32 	%r268, %r265, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r269, %r266, %r267;
	mul.f32 	%r270, %r265, %r268;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r271, %r266, %r269, %r266;
	fma.rn.f32 	%r272, %r265, %r270, %r265;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r273, %r271, 0f3F4C422A;
	mul.f32 	%r274, %r272, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r275, %r265, 0f3F000000;
	mul.f32 	%r276, %r266, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r277, %r273, 0fC0000000;
	mul.f32 	%r278, %r274, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r279, %r277, 0f3FB8AA3B;
	ex2.approx.f32 	%r280, %r279;
	mul.f32 	%r281, %r278, 0f3FB8AA3B;
	ex2.approx.f32 	%r282, %r281;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r283, %r280, 0f3F800000;
	add.f32 	%r284, %r282, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r285, %r60, %r283;
	div.full.f32 	%r286, %r60, %r284;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r287, %r285, 0fBF800000;
	add.f32 	%r288, %r286, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r289, %r288, 0f3F800000;
	add.f32 	%r290, %r287, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r291, %r276, %r290;
	mul.f32 	%r292, %r275, %r289;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r25, %r292, %r291;
	.loc	1 118 47                        // sk11_vision.py:118:47
	// begin inline asm
...
_QVAR0_1 = _Nativo(
    "sk11_vision/_sk11_bias_gelu_kernel/blk4096",
    _QPTX0_1, "_sk11_bias_gelu_kernel",
    warps=8, shared=0,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 4096},
    div16=[3, 4, 5],
...
// %bb.0:
	ld.param.b64 	%rd13, [_sk11_bias_gelu_kernel_param_0];
	ld.param.b64 	%rd14, [_sk11_bias_gelu_kernel_param_1];
$L__tmp0:
	.loc	1 111 24                        // sk11_vision.py:111:24
	mov.u32 	%r50, %ctaid.x;
	ld.param.b64 	%rd15, [_sk11_bias_gelu_kernel_param_2];
	.loc	1 112 24                        // sk11_vision.py:112:24
	mov.u32 	%r51, %tid.x;
	shl.b32 	%r52, %r51, 3;
	ld.param.b32 	%r53, [_sk11_bias_gelu_kernel_param_3];
	and.b32 	%r54, %r52, 2040;
	ld.param.b32 	%r55, [_sk11_bias_gelu_kernel_param_4];
	or.b32 	%r56, %r54, 2048;
	ld.param.b32 	%r57, [_sk11_bias_gelu_kernel_param_5];
	or.b32 	%r58, %r54, 4096;
	or.b32 	%r59, %r52, 6144;
	.loc	1 113 18                        // sk11_vision.py:113:18
	setp.lt.s32 	%p1, %r54, %r53;
	setp.lt.s32 	%p2, %r56, %r53;
	setp.lt.s32 	%p3, %r58, %r53;
	setp.lt.s32 	%p4, %r59, %r53;
	.loc	1 114 30                        // sk11_vision.py:114:30
	mul.lo.s32 	%r60, %r55, %r50;
	.loc	1 114 24                        // sk11_vision.py:114:24
	mad.wide.s32 	%rd16, %r60, 2, %rd13;
	.loc	1 114 42                        // sk11_vision.py:114:42
	mul.wide.u32 	%rd17, %r54, 2;
	...
	// end inline asm
	.loc	1 118 29                        // sk11_vision.py:118:29
	mul.lo.s32 	%r61, %r57, %r50;
	.loc	1 118 23                        // sk11_vision.py:118:23
	mad.wide.s32 	%rd19, %r61, 2, %rd15;
	.loc	1 118 41                        // sk11_vision.py:118:41
	...
	add.f32 	%r67, %r62, %r64;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r68, %r67, 0f3D372713;
	mul.f32 	%r69, %r66, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r70, %r67, %r68;
	mul.f32 	%r71, %r66, %r69;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r72, %r67, %r70, %r67;
	fma.rn.f32 	%r73, %r66, %r71, %r66;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r74, %r72, 0f3F4C422A;
	mul.f32 	%r75, %r73, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r76, %r66, 0f3F000000;
	mul.f32 	%r77, %r67, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r78, %r74, 0fC0000000;
	mul.f32 	%r79, %r75, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r80, %r78, 0f3FB8AA3B;
	ex2.approx.f32 	%r81, %r80;
	mul.f32 	%r82, %r79, 0f3FB8AA3B;
	ex2.approx.f32 	%r83, %r82;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r84, %r81, 0f3F800000;
	add.f32 	%r85, %r83, 0f3F800000;
	mov.b32 	%r86, 0f40000000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r87, %r86, %r84;
	div.full.f32 	%r88, %r86, %r85;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r89, %r87, 0fBF800000;
	add.f32 	%r90, %r88, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r91, %r90, 0f3F800000;
	add.f32 	%r92, %r89, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r93, %r77, %r92;
	mul.f32 	%r94, %r76, %r91;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r34, %r94, %r93;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs5, %rs6}, %r2;
	cvt.f32.bf16 	%r95, %rs5;
	cvt.f32.bf16 	%r96, %rs6;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs7, %rs8}, %r19;
	cvt.f32.bf16 	%r97, %rs7;
	cvt.f32.bf16 	%r98, %rs8;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r99, %r96, %r98;
	add.f32 	%r100, %r95, %r97;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r101, %r100, 0f3D372713;
	mul.f32 	%r102, %r99, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r103, %r100, %r101;
	mul.f32 	%r104, %r99, %r102;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r105, %r100, %r103, %r100;
	fma.rn.f32 	%r106, %r99, %r104, %r99;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r107, %r105, 0f3F4C422A;
	mul.f32 	%r108, %r106, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r109, %r99, 0f3F000000;
	mul.f32 	%r110, %r100, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r111, %r107, 0fC0000000;
	mul.f32 	%r112, %r108, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r113, %r111, 0f3FB8AA3B;
	ex2.approx.f32 	%r114, %r113;
	mul.f32 	%r115, %r112, 0f3FB8AA3B;
	ex2.approx.f32 	%r116, %r115;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r117, %r114, 0f3F800000;
	add.f32 	%r118, %r116, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r119, %r86, %r117;
	div.full.f32 	%r120, %r86, %r118;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r121, %r119, 0fBF800000;
	add.f32 	%r122, %r120, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r123, %r122, 0f3F800000;
	add.f32 	%r124, %r121, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r125, %r110, %r124;
	mul.f32 	%r126, %r109, %r123;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r35, %r126, %r125;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs9, %rs10}, %r3;
	cvt.f32.bf16 	%r127, %rs9;
	cvt.f32.bf16 	%r128, %rs10;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs11, %rs12}, %r20;
	cvt.f32.bf16 	%r129, %rs11;
	cvt.f32.bf16 	%r130, %rs12;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r131, %r128, %r130;
	add.f32 	%r132, %r127, %r129;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r133, %r132, 0f3D372713;
	mul.f32 	%r134, %r131, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r135, %r132, %r133;
	mul.f32 	%r136, %r131, %r134;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r137, %r132, %r135, %r132;
	fma.rn.f32 	%r138, %r131, %r136, %r131;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r139, %r137, 0f3F4C422A;
	mul.f32 	%r140, %r138, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r141, %r131, 0f3F000000;
	mul.f32 	%r142, %r132, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r143, %r139, 0fC0000000;
	mul.f32 	%r144, %r140, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r145, %r143, 0f3FB8AA3B;
	ex2.approx.f32 	%r146, %r145;
	mul.f32 	%r147, %r144, 0f3FB8AA3B;
	ex2.approx.f32 	%r148, %r147;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r149, %r146, 0f3F800000;
	add.f32 	%r150, %r148, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r151, %r86, %r149;
	div.full.f32 	%r152, %r86, %r150;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r153, %r151, 0fBF800000;
	add.f32 	%r154, %r152, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r155, %r154, 0f3F800000;
	add.f32 	%r156, %r153, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r157, %r142, %r156;
	mul.f32 	%r158, %r141, %r155;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r36, %r158, %r157;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs13, %rs14}, %r4;
	...
	cvt.f32.bf16 	%r161, %rs15;
	cvt.f32.bf16 	%r162, %rs16;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r163, %r160, %r162;
	add.f32 	%r164, %r159, %r161;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r165, %r164, 0f3D372713;
	mul.f32 	%r166, %r163, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r167, %r164, %r165;
	mul.f32 	%r168, %r163, %r166;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r169, %r164, %r167, %r164;
	fma.rn.f32 	%r170, %r163, %r168, %r163;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r171, %r169, 0f3F4C422A;
	mul.f32 	%r172, %r170, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r173, %r163, 0f3F000000;
	mul.f32 	%r174, %r164, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r175, %r171, 0fC0000000;
	mul.f32 	%r176, %r172, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r177, %r175, 0f3FB8AA3B;
	ex2.approx.f32 	%r178, %r177;
	mul.f32 	%r179, %r176, 0f3FB8AA3B;
	ex2.approx.f32 	%r180, %r179;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r181, %r178, 0f3F800000;
	add.f32 	%r182, %r180, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r183, %r86, %r181;
	div.full.f32 	%r184, %r86, %r182;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r185, %r183, 0fBF800000;
	add.f32 	%r186, %r184, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r187, %r186, 0f3F800000;
	add.f32 	%r188, %r185, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r189, %r174, %r188;
	mul.f32 	%r190, %r173, %r187;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r37, %r190, %r189;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs17, %rs18}, %r6;
	cvt.f32.bf16 	%r191, %rs17;
	cvt.f32.bf16 	%r192, %rs18;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs19, %rs20}, %r22;
	cvt.f32.bf16 	%r193, %rs19;
	cvt.f32.bf16 	%r194, %rs20;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r195, %r192, %r194;
	add.f32 	%r196, %r191, %r193;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r197, %r196, 0f3D372713;
	mul.f32 	%r198, %r195, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r199, %r196, %r197;
	mul.f32 	%r200, %r195, %r198;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r201, %r196, %r199, %r196;
	fma.rn.f32 	%r202, %r195, %r200, %r195;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r203, %r201, 0f3F4C422A;
	mul.f32 	%r204, %r202, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r205, %r195, 0f3F000000;
	mul.f32 	%r206, %r196, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r207, %r203, 0fC0000000;
	mul.f32 	%r208, %r204, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r209, %r207, 0f3FB8AA3B;
	ex2.approx.f32 	%r210, %r209;
	mul.f32 	%r211, %r208, 0f3FB8AA3B;
	ex2.approx.f32 	%r212, %r211;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r213, %r210, 0f3F800000;
	add.f32 	%r214, %r212, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r215, %r86, %r213;
	div.full.f32 	%r216, %r86, %r214;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r217, %r215, 0fBF800000;
	add.f32 	%r218, %r216, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r219, %r218, 0f3F800000;
	add.f32 	%r220, %r217, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r221, %r206, %r220;
	mul.f32 	%r222, %r205, %r219;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r38, %r222, %r221;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs21, %rs22}, %r7;
	cvt.f32.bf16 	%r223, %rs21;
	cvt.f32.bf16 	%r224, %rs22;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs23, %rs24}, %r23;
	cvt.f32.bf16 	%r225, %rs23;
	cvt.f32.bf16 	%r226, %rs24;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r227, %r224, %r226;
	add.f32 	%r228, %r223, %r225;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r229, %r228, 0f3D372713;
	mul.f32 	%r230, %r227, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r231, %r228, %r229;
	mul.f32 	%r232, %r227, %r230;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r233, %r228, %r231, %r228;
	fma.rn.f32 	%r234, %r227, %r232, %r227;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r235, %r233, 0f3F4C422A;
	mul.f32 	%r236, %r234, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r237, %r227, 0f3F000000;
	mul.f32 	%r238, %r228, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r239, %r235, 0fC0000000;
	mul.f32 	%r240, %r236, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r241, %r239, 0f3FB8AA3B;
	ex2.approx.f32 	%r242, %r241;
	mul.f32 	%r243, %r240, 0f3FB8AA3B;
	ex2.approx.f32 	%r244, %r243;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r245, %r242, 0f3F800000;
	add.f32 	%r246, %r244, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r247, %r86, %r245;
	div.full.f32 	%r248, %r86, %r246;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r249, %r247, 0fBF800000;
	add.f32 	%r250, %r248, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r251, %r250, 0f3F800000;
	add.f32 	%r252, %r249, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r253, %r238, %r252;
	mul.f32 	%r254, %r237, %r251;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r39, %r254, %r253;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs25, %rs26}, %r8;
	cvt.f32.bf16 	%r255, %rs25;
	cvt.f32.bf16 	%r256, %rs26;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs27, %rs28}, %r24;
	cvt.f32.bf16 	%r257, %rs27;
	cvt.f32.bf16 	%r258, %rs28;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r259, %r256, %r258;
	add.f32 	%r260, %r255, %r257;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r261, %r260, 0f3D372713;
	mul.f32 	%r262, %r259, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r263, %r260, %r261;
	mul.f32 	%r264, %r259, %r262;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r265, %r260, %r263, %r260;
	fma.rn.f32 	%r266, %r259, %r264, %r259;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r267, %r265, 0f3F4C422A;
	mul.f32 	%r268, %r266, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r269, %r259, 0f3F000000;
	mul.f32 	%r270, %r260, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r271, %r267, 0fC0000000;
	mul.f32 	%r272, %r268, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r273, %r271, 0f3FB8AA3B;
	ex2.approx.f32 	%r274, %r273;
	mul.f32 	%r275, %r272, 0f3FB8AA3B;
	ex2.approx.f32 	%r276, %r275;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r277, %r274, 0f3F800000;
	add.f32 	%r278, %r276, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r279, %r86, %r277;
	div.full.f32 	%r280, %r86, %r278;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r281, %r279, 0fBF800000;
	add.f32 	%r282, %r280, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r283, %r282, 0f3F800000;
	add.f32 	%r284, %r281, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r285, %r270, %r284;
	mul.f32 	%r286, %r269, %r283;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r40, %r286, %r285;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs29, %rs30}, %r9;
	cvt.f32.bf16 	%r287, %rs29;
	cvt.f32.bf16 	%r288, %rs30;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs31, %rs32}, %r25;
	cvt.f32.bf16 	%r289, %rs31;
	cvt.f32.bf16 	%r290, %rs32;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r291, %r288, %r290;
	add.f32 	%r292, %r287, %r289;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r293, %r292, 0f3D372713;
	mul.f32 	%r294, %r291, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r295, %r292, %r293;
	mul.f32 	%r296, %r291, %r294;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r297, %r292, %r295, %r292;
	fma.rn.f32 	%r298, %r291, %r296, %r291;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r299, %r297, 0f3F4C422A;
	mul.f32 	%r300, %r298, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r301, %r291, 0f3F000000;
	mul.f32 	%r302, %r292, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r303, %r299, 0fC0000000;
	mul.f32 	%r304, %r300, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r305, %r303, 0f3FB8AA3B;
	ex2.approx.f32 	%r306, %r305;
	mul.f32 	%r307, %r304, 0f3FB8AA3B;
	ex2.approx.f32 	%r308, %r307;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r309, %r306, 0f3F800000;
	add.f32 	%r310, %r308, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r311, %r86, %r309;
	div.full.f32 	%r312, %r86, %r310;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r313, %r311, 0fBF800000;
	add.f32 	%r314, %r312, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r315, %r314, 0f3F800000;
	add.f32 	%r316, %r313, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r317, %r302, %r316;
	mul.f32 	%r318, %r301, %r315;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r41, %r318, %r317;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs33, %rs34}, %r10;
	cvt.f32.bf16 	%r319, %rs33;
	cvt.f32.bf16 	%r320, %rs34;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs35, %rs36}, %r26;
	cvt.f32.bf16 	%r321, %rs35;
	cvt.f32.bf16 	%r322, %rs36;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r323, %r320, %r322;
	add.f32 	%r324, %r319, %r321;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r325, %r324, 0f3D372713;
	mul.f32 	%r326, %r323, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r327, %r324, %r325;
	mul.f32 	%r328, %r323, %r326;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r329, %r324, %r327, %r324;
	fma.rn.f32 	%r330, %r323, %r328, %r323;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r331, %r329, 0f3F4C422A;
	mul.f32 	%r332, %r330, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r333, %r323, 0f3F000000;
	mul.f32 	%r334, %r324, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r335, %r331, 0fC0000000;
	mul.f32 	%r336, %r332, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r337, %r335, 0f3FB8AA3B;
	ex2.approx.f32 	%r338, %r337;
	mul.f32 	%r339, %r336, 0f3FB8AA3B;
	ex2.approx.f32 	%r340, %r339;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r341, %r338, 0f3F800000;
	add.f32 	%r342, %r340, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r343, %r86, %r341;
	div.full.f32 	%r344, %r86, %r342;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r345, %r343, 0fBF800000;
	add.f32 	%r346, %r344, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r347, %r346, 0f3F800000;
	add.f32 	%r348, %r345, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r349, %r334, %r348;
	mul.f32 	%r350, %r333, %r347;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r42, %r350, %r349;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs37, %rs38}, %r11;
	cvt.f32.bf16 	%r351, %rs37;
	cvt.f32.bf16 	%r352, %rs38;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs39, %rs40}, %r27;
	cvt.f32.bf16 	%r353, %rs39;
	cvt.f32.bf16 	%r354, %rs40;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r355, %r352, %r354;
	add.f32 	%r356, %r351, %r353;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r357, %r356, 0f3D372713;
	mul.f32 	%r358, %r355, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r359, %r356, %r357;
	mul.f32 	%r360, %r355, %r358;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r361, %r356, %r359, %r356;
	fma.rn.f32 	%r362, %r355, %r360, %r355;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r363, %r361, 0f3F4C422A;
	mul.f32 	%r364, %r362, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r365, %r355, 0f3F000000;
	mul.f32 	%r366, %r356, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r367, %r363, 0fC0000000;
	mul.f32 	%r368, %r364, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r369, %r367, 0f3FB8AA3B;
	ex2.approx.f32 	%r370, %r369;
	mul.f32 	%r371, %r368, 0f3FB8AA3B;
	ex2.approx.f32 	%r372, %r371;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r373, %r370, 0f3F800000;
	add.f32 	%r374, %r372, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r375, %r86, %r373;
	div.full.f32 	%r376, %r86, %r374;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r377, %r375, 0fBF800000;
	add.f32 	%r378, %r376, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r379, %r378, 0f3F800000;
	add.f32 	%r380, %r377, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r381, %r366, %r380;
	mul.f32 	%r382, %r365, %r379;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r43, %r382, %r381;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs41, %rs42}, %r12;
	cvt.f32.bf16 	%r383, %rs41;
	cvt.f32.bf16 	%r384, %rs42;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs43, %rs44}, %r28;
	cvt.f32.bf16 	%r385, %rs43;
	cvt.f32.bf16 	%r386, %rs44;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r387, %r384, %r386;
	add.f32 	%r388, %r383, %r385;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r389, %r388, 0f3D372713;
	mul.f32 	%r390, %r387, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r391, %r388, %r389;
	mul.f32 	%r392, %r387, %r390;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r393, %r388, %r391, %r388;
	fma.rn.f32 	%r394, %r387, %r392, %r387;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r395, %r393, 0f3F4C422A;
	mul.f32 	%r396, %r394, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r397, %r387, 0f3F000000;
	mul.f32 	%r398, %r388, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r399, %r395, 0fC0000000;
	mul.f32 	%r400, %r396, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r401, %r399, 0f3FB8AA3B;
	ex2.approx.f32 	%r402, %r401;
	mul.f32 	%r403, %r400, 0f3FB8AA3B;
	ex2.approx.f32 	%r404, %r403;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r405, %r402, 0f3F800000;
	add.f32 	%r406, %r404, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r407, %r86, %r405;
	div.full.f32 	%r408, %r86, %r406;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r409, %r407, 0fBF800000;
	add.f32 	%r410, %r408, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r411, %r410, 0f3F800000;
	add.f32 	%r412, %r409, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r413, %r398, %r412;
	mul.f32 	%r414, %r397, %r411;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r44, %r414, %r413;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs45, %rs46}, %r13;
	cvt.f32.bf16 	%r415, %rs45;
	cvt.f32.bf16 	%r416, %rs46;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs47, %rs48}, %r29;
	cvt.f32.bf16 	%r417, %rs47;
	cvt.f32.bf16 	%r418, %rs48;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r419, %r416, %r418;
	add.f32 	%r420, %r415, %r417;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r421, %r420, 0f3D372713;
	mul.f32 	%r422, %r419, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r423, %r420, %r421;
	mul.f32 	%r424, %r419, %r422;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r425, %r420, %r423, %r420;
	fma.rn.f32 	%r426, %r419, %r424, %r419;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r427, %r425, 0f3F4C422A;
	mul.f32 	%r428, %r426, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r429, %r419, 0f3F000000;
	mul.f32 	%r430, %r420, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r431, %r427, 0fC0000000;
	mul.f32 	%r432, %r428, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r433, %r431, 0f3FB8AA3B;
	ex2.approx.f32 	%r434, %r433;
	mul.f32 	%r435, %r432, 0f3FB8AA3B;
	ex2.approx.f32 	%r436, %r435;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r437, %r434, 0f3F800000;
	add.f32 	%r438, %r436, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r439, %r86, %r437;
	div.full.f32 	%r440, %r86, %r438;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r441, %r439, 0fBF800000;
	add.f32 	%r442, %r440, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r443, %r442, 0f3F800000;
	add.f32 	%r444, %r441, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r445, %r430, %r444;
	mul.f32 	%r446, %r429, %r443;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r45, %r446, %r445;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs49, %rs50}, %r14;
	cvt.f32.bf16 	%r447, %rs49;
	cvt.f32.bf16 	%r448, %rs50;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs51, %rs52}, %r30;
	cvt.f32.bf16 	%r449, %rs51;
	cvt.f32.bf16 	%r450, %rs52;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r451, %r448, %r450;
	add.f32 	%r452, %r447, %r449;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r453, %r452, 0f3D372713;
	mul.f32 	%r454, %r451, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r455, %r452, %r453;
	mul.f32 	%r456, %r451, %r454;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r457, %r452, %r455, %r452;
	fma.rn.f32 	%r458, %r451, %r456, %r451;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r459, %r457, 0f3F4C422A;
	mul.f32 	%r460, %r458, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r461, %r451, 0f3F000000;
	mul.f32 	%r462, %r452, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r463, %r459, 0fC0000000;
	mul.f32 	%r464, %r460, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r465, %r463, 0f3FB8AA3B;
	ex2.approx.f32 	%r466, %r465;
	mul.f32 	%r467, %r464, 0f3FB8AA3B;
	ex2.approx.f32 	%r468, %r467;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r469, %r466, 0f3F800000;
	add.f32 	%r470, %r468, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r471, %r86, %r469;
	div.full.f32 	%r472, %r86, %r470;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r473, %r471, 0fBF800000;
	add.f32 	%r474, %r472, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r475, %r474, 0f3F800000;
	add.f32 	%r476, %r473, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r477, %r462, %r476;
	mul.f32 	%r478, %r461, %r475;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r46, %r478, %r477;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs53, %rs54}, %r15;
	cvt.f32.bf16 	%r479, %rs53;
	cvt.f32.bf16 	%r480, %rs54;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs55, %rs56}, %r31;
	cvt.f32.bf16 	%r481, %rs55;
	cvt.f32.bf16 	%r482, %rs56;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r483, %r480, %r482;
	add.f32 	%r484, %r479, %r481;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r485, %r484, 0f3D372713;
	mul.f32 	%r486, %r483, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r487, %r484, %r485;
	mul.f32 	%r488, %r483, %r486;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r489, %r484, %r487, %r484;
	fma.rn.f32 	%r490, %r483, %r488, %r483;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r491, %r489, 0f3F4C422A;
	mul.f32 	%r492, %r490, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r493, %r483, 0f3F000000;
	mul.f32 	%r494, %r484, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r495, %r491, 0fC0000000;
	mul.f32 	%r496, %r492, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r497, %r495, 0f3FB8AA3B;
	ex2.approx.f32 	%r498, %r497;
	mul.f32 	%r499, %r496, 0f3FB8AA3B;
	ex2.approx.f32 	%r500, %r499;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r501, %r498, 0f3F800000;
	add.f32 	%r502, %r500, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r503, %r86, %r501;
	div.full.f32 	%r504, %r86, %r502;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r505, %r503, 0fBF800000;
	add.f32 	%r506, %r504, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r507, %r506, 0f3F800000;
	add.f32 	%r508, %r505, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r509, %r494, %r508;
	mul.f32 	%r510, %r493, %r507;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r47, %r510, %r509;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs57, %rs58}, %r16;
	cvt.f32.bf16 	%r511, %rs57;
	cvt.f32.bf16 	%r512, %rs58;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs59, %rs60}, %r32;
	cvt.f32.bf16 	%r513, %rs59;
	cvt.f32.bf16 	%r514, %rs60;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r515, %r512, %r514;
	add.f32 	%r516, %r511, %r513;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r517, %r516, 0f3D372713;
	mul.f32 	%r518, %r515, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r519, %r516, %r517;
	mul.f32 	%r520, %r515, %r518;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r521, %r516, %r519, %r516;
	fma.rn.f32 	%r522, %r515, %r520, %r515;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r523, %r521, 0f3F4C422A;
	mul.f32 	%r524, %r522, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r525, %r515, 0f3F000000;
	mul.f32 	%r526, %r516, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r527, %r523, 0fC0000000;
	mul.f32 	%r528, %r524, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r529, %r527, 0f3FB8AA3B;
	ex2.approx.f32 	%r530, %r529;
	mul.f32 	%r531, %r528, 0f3FB8AA3B;
	ex2.approx.f32 	%r532, %r531;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r533, %r530, 0f3F800000;
	add.f32 	%r534, %r532, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r535, %r86, %r533;
	div.full.f32 	%r536, %r86, %r534;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r537, %r535, 0fBF800000;
	add.f32 	%r538, %r536, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r539, %r538, 0f3F800000;
	add.f32 	%r540, %r537, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r541, %r526, %r540;
	mul.f32 	%r542, %r525, %r539;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r48, %r542, %r541;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs61, %rs62}, %r17;
	cvt.f32.bf16 	%r543, %rs61;
	cvt.f32.bf16 	%r544, %rs62;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs63, %rs64}, %r33;
	cvt.f32.bf16 	%r545, %rs63;
	cvt.f32.bf16 	%r546, %rs64;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r547, %r544, %r546;
	add.f32 	%r548, %r543, %r545;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r549, %r548, 0f3D372713;
	mul.f32 	%r550, %r547, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r551, %r548, %r549;
	mul.f32 	%r552, %r547, %r550;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r553, %r548, %r551, %r548;
	fma.rn.f32 	%r554, %r547, %r552, %r547;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r555, %r553, 0f3F4C422A;
	mul.f32 	%r556, %r554, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r557, %r547, 0f3F000000;
	mul.f32 	%r558, %r548, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r559, %r555, 0fC0000000;
	mul.f32 	%r560, %r556, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r561, %r559, 0f3FB8AA3B;
	ex2.approx.f32 	%r562, %r561;
	mul.f32 	%r563, %r560, 0f3FB8AA3B;
	ex2.approx.f32 	%r564, %r563;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r565, %r562, 0f3F800000;
	add.f32 	%r566, %r564, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r567, %r86, %r565;
	div.full.f32 	%r568, %r86, %r566;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r569, %r567, 0fBF800000;
	add.f32 	%r570, %r568, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r571, %r570, 0f3F800000;
	add.f32 	%r572, %r569, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r573, %r558, %r572;
	mul.f32 	%r574, %r557, %r571;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r49, %r574, %r573;
	.loc	1 118 47                        // sk11_vision.py:118:47
	// begin inline asm
	@%p1 st.global.v4.b32 [ %rd9 + 0 ], { %r34, %r35, %r36, %r37 };
	// end inline asm
	// begin inline asm
	@%p2 st.global.v4.b32 [ %rd10 + 0 ], { %r38, %r39, %r40, %r41 };
	// end inline asm
	// begin inline asm
	@%p3 st.global.v4.b32 [ %rd11 + 0 ], { %r42, %r43, %r44, %r45 };
	// end inline asm
	// begin inline asm
	@%p4 st.global.v4.b32 [ %rd12 + 0 ], { %r46, %r47, %r48, %r49 };
	// end inline asm
	.loc	1 118 4                         // sk11_vision.py:118:4
	ret;
$L__tmp1:
...
_QVAR0_2 = _Nativo(
    "sk11_vision/_sk11_bias_gelu_kernel/blk8192",
    _QPTX0_2, "_sk11_bias_gelu_kernel",
    warps=8, shared=0,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 8192},
    div16=[3, 4, 5],
...
// %bb.0:
	ld.param.b64 	%rd25, [_sk11_bias_gelu_kernel_param_0];
	ld.param.b64 	%rd26, [_sk11_bias_gelu_kernel_param_1];
$L__tmp0:
	.loc	1 111 24                        // sk11_vision.py:111:24
	mov.u32 	%r98, %ctaid.x;
	ld.param.b64 	%rd27, [_sk11_bias_gelu_kernel_param_2];
	.loc	1 112 24                        // sk11_vision.py:112:24
	mov.u32 	%r99, %tid.x;
	shl.b32 	%r100, %r99, 3;
	ld.param.b32 	%r101, [_sk11_bias_gelu_kernel_param_3];
	and.b32 	%r102, %r100, 2040;
	ld.param.b32 	%r103, [_sk11_bias_gelu_kernel_param_4];
	or.b32 	%r104, %r102, 2048;
	ld.param.b32 	%r105, [_sk11_bias_gelu_kernel_param_5];
	or.b32 	%r106, %r102, 4096;
	or.b32 	%r107, %r100, 6144;
	or.b32 	%r108, %r102, 8192;
	or.b32 	%r109, %r102, 10240;
	or.b32 	%r110, %r102, 12288;
	or.b32 	%r111, %r100, 14336;
	.loc	1 113 18                        // sk11_vision.py:113:18
	setp.lt.s32 	%p1, %r102, %r101;
	setp.lt.s32 	%p2, %r104, %r101;
	setp.lt.s32 	%p3, %r106, %r101;
	setp.lt.s32 	%p4, %r107, %r101;
	setp.lt.s32 	%p5, %r108, %r101;
	setp.lt.s32 	%p6, %r109, %r101;
	setp.lt.s32 	%p7, %r110, %r101;
	setp.lt.s32 	%p8, %r111, %r101;
	.loc	1 114 30                        // sk11_vision.py:114:30
	mul.lo.s32 	%r112, %r103, %r98;
	.loc	1 114 24                        // sk11_vision.py:114:24
	mad.wide.s32 	%rd28, %r112, 2, %rd25;
	.loc	1 114 42                        // sk11_vision.py:114:42
	mul.wide.u32 	%rd29, %r102, 2;
	add.s64 	%rd1, %rd28, %rd29;
	add.s64 	%rd2, %rd1, 4096;
	add.s64 	%rd3, %rd1, 8192;
	mul.wide.u32 	%rd30, %r107, 2;
	add.s64 	%rd4, %rd28, %rd30;
	add.s64 	%rd5, %rd1, 16384;
	add.s64 	%rd6, %rd1, 20480;
	add.s64 	%rd7, %rd1, 24576;
	mul.wide.u32 	%rd31, %r111, 2;
	...
	// end inline asm
	.loc	1 118 29                        // sk11_vision.py:118:29
	mul.lo.s32 	%r113, %r105, %r98;
	.loc	1 118 23                        // sk11_vision.py:118:23
	mad.wide.s32 	%rd32, %r113, 2, %rd27;
	.loc	1 118 41                        // sk11_vision.py:118:41
	...
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs1, %rs2}, %r1;
	cvt.f32.bf16 	%r114, %rs1;
	cvt.f32.bf16 	%r115, %rs2;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs3, %rs4}, %r34;
	cvt.f32.bf16 	%r116, %rs3;
	cvt.f32.bf16 	%r117, %rs4;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r118, %r115, %r117;
	add.f32 	%r119, %r114, %r116;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r120, %r119, 0f3D372713;
	mul.f32 	%r121, %r118, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r122, %r119, %r120;
	mul.f32 	%r123, %r118, %r121;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r124, %r119, %r122, %r119;
	fma.rn.f32 	%r125, %r118, %r123, %r118;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r126, %r124, 0f3F4C422A;
	mul.f32 	%r127, %r125, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r128, %r118, 0f3F000000;
	mul.f32 	%r129, %r119, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r130, %r126, 0fC0000000;
	mul.f32 	%r131, %r127, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r132, %r130, 0f3FB8AA3B;
	ex2.approx.f32 	%r133, %r132;
	mul.f32 	%r134, %r131, 0f3FB8AA3B;
	ex2.approx.f32 	%r135, %r134;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r136, %r133, 0f3F800000;
	add.f32 	%r137, %r135, 0f3F800000;
	mov.b32 	%r138, 0f40000000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r139, %r138, %r136;
	div.full.f32 	%r140, %r138, %r137;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r141, %r139, 0fBF800000;
	add.f32 	%r142, %r140, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r143, %r142, 0f3F800000;
	add.f32 	%r144, %r141, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r145, %r129, %r144;
	mul.f32 	%r146, %r128, %r143;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r66, %r146, %r145;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs5, %rs6}, %r2;
	cvt.f32.bf16 	%r147, %rs5;
	cvt.f32.bf16 	%r148, %rs6;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs7, %rs8}, %r35;
	cvt.f32.bf16 	%r149, %rs7;
	cvt.f32.bf16 	%r150, %rs8;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r151, %r148, %r150;
	add.f32 	%r152, %r147, %r149;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r153, %r152, 0f3D372713;
	mul.f32 	%r154, %r151, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r155, %r152, %r153;
	mul.f32 	%r156, %r151, %r154;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r157, %r152, %r155, %r152;
	fma.rn.f32 	%r158, %r151, %r156, %r151;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r159, %r157, 0f3F4C422A;
	mul.f32 	%r160, %r158, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r161, %r151, 0f3F000000;
	mul.f32 	%r162, %r152, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r163, %r159, 0fC0000000;
	mul.f32 	%r164, %r160, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r165, %r163, 0f3FB8AA3B;
	ex2.approx.f32 	%r166, %r165;
	mul.f32 	%r167, %r164, 0f3FB8AA3B;
	ex2.approx.f32 	%r168, %r167;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r169, %r166, 0f3F800000;
	add.f32 	%r170, %r168, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r171, %r138, %r169;
	div.full.f32 	%r172, %r138, %r170;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r173, %r171, 0fBF800000;
	add.f32 	%r174, %r172, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r175, %r174, 0f3F800000;
	add.f32 	%r176, %r173, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r177, %r162, %r176;
	mul.f32 	%r178, %r161, %r175;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r67, %r178, %r177;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs9, %rs10}, %r3;
	cvt.f32.bf16 	%r179, %rs9;
	cvt.f32.bf16 	%r180, %rs10;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs11, %rs12}, %r36;
	cvt.f32.bf16 	%r181, %rs11;
	cvt.f32.bf16 	%r182, %rs12;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r183, %r180, %r182;
	add.f32 	%r184, %r179, %r181;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r185, %r184, 0f3D372713;
	mul.f32 	%r186, %r183, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r187, %r184, %r185;
	mul.f32 	%r188, %r183, %r186;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r189, %r184, %r187, %r184;
	fma.rn.f32 	%r190, %r183, %r188, %r183;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r191, %r189, 0f3F4C422A;
	mul.f32 	%r192, %r190, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r193, %r183, 0f3F000000;
	mul.f32 	%r194, %r184, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r195, %r191, 0fC0000000;
	mul.f32 	%r196, %r192, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r197, %r195, 0f3FB8AA3B;
	ex2.approx.f32 	%r198, %r197;
	mul.f32 	%r199, %r196, 0f3FB8AA3B;
	ex2.approx.f32 	%r200, %r199;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r201, %r198, 0f3F800000;
	add.f32 	%r202, %r200, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r203, %r138, %r201;
	div.full.f32 	%r204, %r138, %r202;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r205, %r203, 0fBF800000;
	add.f32 	%r206, %r204, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r207, %r206, 0f3F800000;
	add.f32 	%r208, %r205, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r209, %r194, %r208;
	mul.f32 	%r210, %r193, %r207;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r68, %r210, %r209;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs13, %rs14}, %r4;
	cvt.f32.bf16 	%r211, %rs13;
	cvt.f32.bf16 	%r212, %rs14;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs15, %rs16}, %r37;
	cvt.f32.bf16 	%r213, %rs15;
	cvt.f32.bf16 	%r214, %rs16;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r215, %r212, %r214;
	add.f32 	%r216, %r211, %r213;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r217, %r216, 0f3D372713;
	mul.f32 	%r218, %r215, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r219, %r216, %r217;
	mul.f32 	%r220, %r215, %r218;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r221, %r216, %r219, %r216;
	fma.rn.f32 	%r222, %r215, %r220, %r215;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r223, %r221, 0f3F4C422A;
	mul.f32 	%r224, %r222, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r225, %r215, 0f3F000000;
	mul.f32 	%r226, %r216, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r227, %r223, 0fC0000000;
	mul.f32 	%r228, %r224, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r229, %r227, 0f3FB8AA3B;
	ex2.approx.f32 	%r230, %r229;
	mul.f32 	%r231, %r228, 0f3FB8AA3B;
	ex2.approx.f32 	%r232, %r231;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r233, %r230, 0f3F800000;
	add.f32 	%r234, %r232, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r235, %r138, %r233;
	div.full.f32 	%r236, %r138, %r234;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r237, %r235, 0fBF800000;
	add.f32 	%r238, %r236, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r239, %r238, 0f3F800000;
	add.f32 	%r240, %r237, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r241, %r226, %r240;
	mul.f32 	%r242, %r225, %r239;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r69, %r242, %r241;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs17, %rs18}, %r6;
	cvt.f32.bf16 	%r243, %rs17;
	cvt.f32.bf16 	%r244, %rs18;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs19, %rs20}, %r38;
	cvt.f32.bf16 	%r245, %rs19;
	cvt.f32.bf16 	%r246, %rs20;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r247, %r244, %r246;
	add.f32 	%r248, %r243, %r245;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r249, %r248, 0f3D372713;
	mul.f32 	%r250, %r247, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r251, %r248, %r249;
	mul.f32 	%r252, %r247, %r250;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r253, %r248, %r251, %r248;
	fma.rn.f32 	%r254, %r247, %r252, %r247;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r255, %r253, 0f3F4C422A;
	mul.f32 	%r256, %r254, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r257, %r247, 0f3F000000;
	mul.f32 	%r258, %r248, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r259, %r255, 0fC0000000;
	mul.f32 	%r260, %r256, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r261, %r259, 0f3FB8AA3B;
	ex2.approx.f32 	%r262, %r261;
	mul.f32 	%r263, %r260, 0f3FB8AA3B;
	ex2.approx.f32 	%r264, %r263;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r265, %r262, 0f3F800000;
	add.f32 	%r266, %r264, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r267, %r138, %r265;
	div.full.f32 	%r268, %r138, %r266;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r269, %r267, 0fBF800000;
	add.f32 	%r270, %r268, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r271, %r270, 0f3F800000;
	add.f32 	%r272, %r269, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r273, %r258, %r272;
	mul.f32 	%r274, %r257, %r271;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r70, %r274, %r273;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs21, %rs22}, %r7;
	cvt.f32.bf16 	%r275, %rs21;
	cvt.f32.bf16 	%r276, %rs22;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs23, %rs24}, %r39;
	cvt.f32.bf16 	%r277, %rs23;
	cvt.f32.bf16 	%r278, %rs24;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r279, %r276, %r278;
	add.f32 	%r280, %r275, %r277;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r281, %r280, 0f3D372713;
	mul.f32 	%r282, %r279, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r283, %r280, %r281;
	mul.f32 	%r284, %r279, %r282;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r285, %r280, %r283, %r280;
	fma.rn.f32 	%r286, %r279, %r284, %r279;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r287, %r285, 0f3F4C422A;
	mul.f32 	%r288, %r286, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r289, %r279, 0f3F000000;
	mul.f32 	%r290, %r280, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r291, %r287, 0fC0000000;
	mul.f32 	%r292, %r288, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r293, %r291, 0f3FB8AA3B;
	ex2.approx.f32 	%r294, %r293;
	mul.f32 	%r295, %r292, 0f3FB8AA3B;
	ex2.approx.f32 	%r296, %r295;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r297, %r294, 0f3F800000;
	add.f32 	%r298, %r296, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r299, %r138, %r297;
	div.full.f32 	%r300, %r138, %r298;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r301, %r299, 0fBF800000;
	add.f32 	%r302, %r300, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r303, %r302, 0f3F800000;
	add.f32 	%r304, %r301, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r305, %r290, %r304;
	mul.f32 	%r306, %r289, %r303;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r71, %r306, %r305;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs25, %rs26}, %r8;
	cvt.f32.bf16 	%r307, %rs25;
	cvt.f32.bf16 	%r308, %rs26;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs27, %rs28}, %r40;
	cvt.f32.bf16 	%r309, %rs27;
	cvt.f32.bf16 	%r310, %rs28;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r311, %r308, %r310;
	add.f32 	%r312, %r307, %r309;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r313, %r312, 0f3D372713;
	mul.f32 	%r314, %r311, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r315, %r312, %r313;
	mul.f32 	%r316, %r311, %r314;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r317, %r312, %r315, %r312;
	fma.rn.f32 	%r318, %r311, %r316, %r311;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r319, %r317, 0f3F4C422A;
	mul.f32 	%r320, %r318, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r321, %r311, 0f3F000000;
	mul.f32 	%r322, %r312, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r323, %r319, 0fC0000000;
	mul.f32 	%r324, %r320, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r325, %r323, 0f3FB8AA3B;
	ex2.approx.f32 	%r326, %r325;
	mul.f32 	%r327, %r324, 0f3FB8AA3B;
	ex2.approx.f32 	%r328, %r327;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r329, %r326, 0f3F800000;
	add.f32 	%r330, %r328, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r331, %r138, %r329;
	div.full.f32 	%r332, %r138, %r330;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r333, %r331, 0fBF800000;
	add.f32 	%r334, %r332, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r335, %r334, 0f3F800000;
	add.f32 	%r336, %r333, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r337, %r322, %r336;
	mul.f32 	%r338, %r321, %r335;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r72, %r338, %r337;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs29, %rs30}, %r9;
	cvt.f32.bf16 	%r339, %rs29;
	cvt.f32.bf16 	%r340, %rs30;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs31, %rs32}, %r41;
	cvt.f32.bf16 	%r341, %rs31;
	cvt.f32.bf16 	%r342, %rs32;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r343, %r340, %r342;
	add.f32 	%r344, %r339, %r341;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r345, %r344, 0f3D372713;
	mul.f32 	%r346, %r343, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r347, %r344, %r345;
	mul.f32 	%r348, %r343, %r346;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r349, %r344, %r347, %r344;
	fma.rn.f32 	%r350, %r343, %r348, %r343;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r351, %r349, 0f3F4C422A;
	mul.f32 	%r352, %r350, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r353, %r343, 0f3F000000;
	mul.f32 	%r354, %r344, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r355, %r351, 0fC0000000;
	mul.f32 	%r356, %r352, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r357, %r355, 0f3FB8AA3B;
	ex2.approx.f32 	%r358, %r357;
	mul.f32 	%r359, %r356, 0f3FB8AA3B;
	ex2.approx.f32 	%r360, %r359;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r361, %r358, 0f3F800000;
	add.f32 	%r362, %r360, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r363, %r138, %r361;
	div.full.f32 	%r364, %r138, %r362;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r365, %r363, 0fBF800000;
	add.f32 	%r366, %r364, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r367, %r366, 0f3F800000;
	add.f32 	%r368, %r365, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r369, %r354, %r368;
	mul.f32 	%r370, %r353, %r367;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r73, %r370, %r369;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs33, %rs34}, %r10;
	cvt.f32.bf16 	%r371, %rs33;
	cvt.f32.bf16 	%r372, %rs34;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs35, %rs36}, %r42;
	cvt.f32.bf16 	%r373, %rs35;
	cvt.f32.bf16 	%r374, %rs36;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r375, %r372, %r374;
	add.f32 	%r376, %r371, %r373;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r377, %r376, 0f3D372713;
	mul.f32 	%r378, %r375, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r379, %r376, %r377;
	mul.f32 	%r380, %r375, %r378;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r381, %r376, %r379, %r376;
	fma.rn.f32 	%r382, %r375, %r380, %r375;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r383, %r381, 0f3F4C422A;
	mul.f32 	%r384, %r382, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r385, %r375, 0f3F000000;
	mul.f32 	%r386, %r376, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r387, %r383, 0fC0000000;
	mul.f32 	%r388, %r384, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r389, %r387, 0f3FB8AA3B;
	ex2.approx.f32 	%r390, %r389;
	mul.f32 	%r391, %r388, 0f3FB8AA3B;
	ex2.approx.f32 	%r392, %r391;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r393, %r390, 0f3F800000;
	add.f32 	%r394, %r392, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r395, %r138, %r393;
	div.full.f32 	%r396, %r138, %r394;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r397, %r395, 0fBF800000;
	add.f32 	%r398, %r396, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r399, %r398, 0f3F800000;
	add.f32 	%r400, %r397, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r401, %r386, %r400;
	mul.f32 	%r402, %r385, %r399;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r74, %r402, %r401;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs37, %rs38}, %r11;
	cvt.f32.bf16 	%r403, %rs37;
	cvt.f32.bf16 	%r404, %rs38;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs39, %rs40}, %r43;
	cvt.f32.bf16 	%r405, %rs39;
	cvt.f32.bf16 	%r406, %rs40;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r407, %r404, %r406;
	add.f32 	%r408, %r403, %r405;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r409, %r408, 0f3D372713;
	mul.f32 	%r410, %r407, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r411, %r408, %r409;
	mul.f32 	%r412, %r407, %r410;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r413, %r408, %r411, %r408;
	fma.rn.f32 	%r414, %r407, %r412, %r407;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r415, %r413, 0f3F4C422A;
	mul.f32 	%r416, %r414, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r417, %r407, 0f3F000000;
	mul.f32 	%r418, %r408, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r419, %r415, 0fC0000000;
	mul.f32 	%r420, %r416, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r421, %r419, 0f3FB8AA3B;
	ex2.approx.f32 	%r422, %r421;
	mul.f32 	%r423, %r420, 0f3FB8AA3B;
	ex2.approx.f32 	%r424, %r423;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r425, %r422, 0f3F800000;
	add.f32 	%r426, %r424, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r427, %r138, %r425;
	div.full.f32 	%r428, %r138, %r426;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r429, %r427, 0fBF800000;
	add.f32 	%r430, %r428, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r431, %r430, 0f3F800000;
	add.f32 	%r432, %r429, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r433, %r418, %r432;
	mul.f32 	%r434, %r417, %r431;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r75, %r434, %r433;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs41, %rs42}, %r12;
	cvt.f32.bf16 	%r435, %rs41;
	cvt.f32.bf16 	%r436, %rs42;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs43, %rs44}, %r44;
	cvt.f32.bf16 	%r437, %rs43;
	cvt.f32.bf16 	%r438, %rs44;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r439, %r436, %r438;
	add.f32 	%r440, %r435, %r437;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r441, %r440, 0f3D372713;
	mul.f32 	%r442, %r439, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r443, %r440, %r441;
	mul.f32 	%r444, %r439, %r442;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r445, %r440, %r443, %r440;
	fma.rn.f32 	%r446, %r439, %r444, %r439;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r447, %r445, 0f3F4C422A;
	mul.f32 	%r448, %r446, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r449, %r439, 0f3F000000;
	mul.f32 	%r450, %r440, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r451, %r447, 0fC0000000;
	mul.f32 	%r452, %r448, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r453, %r451, 0f3FB8AA3B;
	ex2.approx.f32 	%r454, %r453;
	mul.f32 	%r455, %r452, 0f3FB8AA3B;
	ex2.approx.f32 	%r456, %r455;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r457, %r454, 0f3F800000;
	add.f32 	%r458, %r456, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r459, %r138, %r457;
	div.full.f32 	%r460, %r138, %r458;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r461, %r459, 0fBF800000;
	add.f32 	%r462, %r460, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r463, %r462, 0f3F800000;
	add.f32 	%r464, %r461, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r465, %r450, %r464;
	mul.f32 	%r466, %r449, %r463;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r76, %r466, %r465;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs45, %rs46}, %r13;
	cvt.f32.bf16 	%r467, %rs45;
	cvt.f32.bf16 	%r468, %rs46;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs47, %rs48}, %r45;
	cvt.f32.bf16 	%r469, %rs47;
	cvt.f32.bf16 	%r470, %rs48;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r471, %r468, %r470;
	add.f32 	%r472, %r467, %r469;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r473, %r472, 0f3D372713;
	mul.f32 	%r474, %r471, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	...
	add.f32 	%r490, %r488, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r491, %r138, %r489;
	div.full.f32 	%r492, %r138, %r490;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r493, %r491, 0fBF800000;
	add.f32 	%r494, %r492, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r495, %r494, 0f3F800000;
	add.f32 	%r496, %r493, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r497, %r482, %r496;
	mul.f32 	%r498, %r481, %r495;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r77, %r498, %r497;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs49, %rs50}, %r14;
	cvt.f32.bf16 	%r499, %rs49;
	cvt.f32.bf16 	%r500, %rs50;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs51, %rs52}, %r46;
	cvt.f32.bf16 	%r501, %rs51;
	cvt.f32.bf16 	%r502, %rs52;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r503, %r500, %r502;
	add.f32 	%r504, %r499, %r501;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r505, %r504, 0f3D372713;
	mul.f32 	%r506, %r503, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r507, %r504, %r505;
	mul.f32 	%r508, %r503, %r506;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r509, %r504, %r507, %r504;
	fma.rn.f32 	%r510, %r503, %r508, %r503;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r511, %r509, 0f3F4C422A;
	mul.f32 	%r512, %r510, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r513, %r503, 0f3F000000;
	mul.f32 	%r514, %r504, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r515, %r511, 0fC0000000;
	mul.f32 	%r516, %r512, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r517, %r515, 0f3FB8AA3B;
	ex2.approx.f32 	%r518, %r517;
	mul.f32 	%r519, %r516, 0f3FB8AA3B;
	ex2.approx.f32 	%r520, %r519;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r521, %r518, 0f3F800000;
	add.f32 	%r522, %r520, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r523, %r138, %r521;
	div.full.f32 	%r524, %r138, %r522;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r525, %r523, 0fBF800000;
	add.f32 	%r526, %r524, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r527, %r526, 0f3F800000;
	add.f32 	%r528, %r525, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r529, %r514, %r528;
	mul.f32 	%r530, %r513, %r527;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r78, %r530, %r529;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs53, %rs54}, %r15;
	cvt.f32.bf16 	%r531, %rs53;
	cvt.f32.bf16 	%r532, %rs54;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs55, %rs56}, %r47;
	cvt.f32.bf16 	%r533, %rs55;
	cvt.f32.bf16 	%r534, %rs56;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r535, %r532, %r534;
	add.f32 	%r536, %r531, %r533;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r537, %r536, 0f3D372713;
	mul.f32 	%r538, %r535, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r539, %r536, %r537;
	mul.f32 	%r540, %r535, %r538;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r541, %r536, %r539, %r536;
	fma.rn.f32 	%r542, %r535, %r540, %r535;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r543, %r541, 0f3F4C422A;
	mul.f32 	%r544, %r542, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r545, %r535, 0f3F000000;
	mul.f32 	%r546, %r536, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r547, %r543, 0fC0000000;
	mul.f32 	%r548, %r544, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r549, %r547, 0f3FB8AA3B;
	ex2.approx.f32 	%r550, %r549;
	mul.f32 	%r551, %r548, 0f3FB8AA3B;
	ex2.approx.f32 	%r552, %r551;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r553, %r550, 0f3F800000;
	add.f32 	%r554, %r552, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r555, %r138, %r553;
	div.full.f32 	%r556, %r138, %r554;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r557, %r555, 0fBF800000;
	add.f32 	%r558, %r556, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r559, %r558, 0f3F800000;
	add.f32 	%r560, %r557, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r561, %r546, %r560;
	mul.f32 	%r562, %r545, %r559;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r79, %r562, %r561;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs57, %rs58}, %r16;
	cvt.f32.bf16 	%r563, %rs57;
	cvt.f32.bf16 	%r564, %rs58;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs59, %rs60}, %r48;
	cvt.f32.bf16 	%r565, %rs59;
	cvt.f32.bf16 	%r566, %rs60;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r567, %r564, %r566;
	add.f32 	%r568, %r563, %r565;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r569, %r568, 0f3D372713;
	mul.f32 	%r570, %r567, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r571, %r568, %r569;
	mul.f32 	%r572, %r567, %r570;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r573, %r568, %r571, %r568;
	fma.rn.f32 	%r574, %r567, %r572, %r567;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r575, %r573, 0f3F4C422A;
	mul.f32 	%r576, %r574, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r577, %r567, 0f3F000000;
	mul.f32 	%r578, %r568, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r579, %r575, 0fC0000000;
	mul.f32 	%r580, %r576, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r581, %r579, 0f3FB8AA3B;
	ex2.approx.f32 	%r582, %r581;
	mul.f32 	%r583, %r580, 0f3FB8AA3B;
	ex2.approx.f32 	%r584, %r583;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r585, %r582, 0f3F800000;
	add.f32 	%r586, %r584, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r587, %r138, %r585;
	div.full.f32 	%r588, %r138, %r586;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r589, %r587, 0fBF800000;
	add.f32 	%r590, %r588, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r591, %r590, 0f3F800000;
	add.f32 	%r592, %r589, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r593, %r578, %r592;
	mul.f32 	%r594, %r577, %r591;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r80, %r594, %r593;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs61, %rs62}, %r17;
	cvt.f32.bf16 	%r595, %rs61;
	cvt.f32.bf16 	%r596, %rs62;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs63, %rs64}, %r49;
	cvt.f32.bf16 	%r597, %rs63;
	cvt.f32.bf16 	%r598, %rs64;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r599, %r596, %r598;
	add.f32 	%r600, %r595, %r597;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r601, %r600, 0f3D372713;
	mul.f32 	%r602, %r599, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r603, %r600, %r601;
	mul.f32 	%r604, %r599, %r602;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r605, %r600, %r603, %r600;
	fma.rn.f32 	%r606, %r599, %r604, %r599;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r607, %r605, 0f3F4C422A;
	mul.f32 	%r608, %r606, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r609, %r599, 0f3F000000;
	mul.f32 	%r610, %r600, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r611, %r607, 0fC0000000;
	mul.f32 	%r612, %r608, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r613, %r611, 0f3FB8AA3B;
	ex2.approx.f32 	%r614, %r613;
	mul.f32 	%r615, %r612, 0f3FB8AA3B;
	ex2.approx.f32 	%r616, %r615;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r617, %r614, 0f3F800000;
	add.f32 	%r618, %r616, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r619, %r138, %r617;
	div.full.f32 	%r620, %r138, %r618;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r621, %r619, 0fBF800000;
	add.f32 	%r622, %r620, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r623, %r622, 0f3F800000;
	add.f32 	%r624, %r621, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r625, %r610, %r624;
	mul.f32 	%r626, %r609, %r623;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r81, %r626, %r625;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs65, %rs66}, %r18;
	cvt.f32.bf16 	%r627, %rs65;
	cvt.f32.bf16 	%r628, %rs66;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs67, %rs68}, %r50;
	cvt.f32.bf16 	%r629, %rs67;
	cvt.f32.bf16 	%r630, %rs68;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r631, %r628, %r630;
	add.f32 	%r632, %r627, %r629;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r633, %r632, 0f3D372713;
	mul.f32 	%r634, %r631, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r635, %r632, %r633;
	mul.f32 	%r636, %r631, %r634;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r637, %r632, %r635, %r632;
	fma.rn.f32 	%r638, %r631, %r636, %r631;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r639, %r637, 0f3F4C422A;
	mul.f32 	%r640, %r638, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r641, %r631, 0f3F000000;
	mul.f32 	%r642, %r632, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r643, %r639, 0fC0000000;
	mul.f32 	%r644, %r640, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r645, %r643, 0f3FB8AA3B;
	ex2.approx.f32 	%r646, %r645;
	mul.f32 	%r647, %r644, 0f3FB8AA3B;
	ex2.approx.f32 	%r648, %r647;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r649, %r646, 0f3F800000;
	add.f32 	%r650, %r648, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r651, %r138, %r649;
	div.full.f32 	%r652, %r138, %r650;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r653, %r651, 0fBF800000;
	add.f32 	%r654, %r652, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r655, %r654, 0f3F800000;
	add.f32 	%r656, %r653, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r657, %r642, %r656;
	mul.f32 	%r658, %r641, %r655;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r82, %r658, %r657;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs69, %rs70}, %r19;
	cvt.f32.bf16 	%r659, %rs69;
	cvt.f32.bf16 	%r660, %rs70;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs71, %rs72}, %r51;
	cvt.f32.bf16 	%r661, %rs71;
	cvt.f32.bf16 	%r662, %rs72;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r663, %r660, %r662;
	add.f32 	%r664, %r659, %r661;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r665, %r664, 0f3D372713;
	mul.f32 	%r666, %r663, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r667, %r664, %r665;
	mul.f32 	%r668, %r663, %r666;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r669, %r664, %r667, %r664;
	fma.rn.f32 	%r670, %r663, %r668, %r663;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r671, %r669, 0f3F4C422A;
	mul.f32 	%r672, %r670, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r673, %r663, 0f3F000000;
	mul.f32 	%r674, %r664, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r675, %r671, 0fC0000000;
	mul.f32 	%r676, %r672, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r677, %r675, 0f3FB8AA3B;
	ex2.approx.f32 	%r678, %r677;
	mul.f32 	%r679, %r676, 0f3FB8AA3B;
	ex2.approx.f32 	%r680, %r679;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r681, %r678, 0f3F800000;
	add.f32 	%r682, %r680, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r683, %r138, %r681;
	div.full.f32 	%r684, %r138, %r682;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r685, %r683, 0fBF800000;
	add.f32 	%r686, %r684, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r687, %r686, 0f3F800000;
	add.f32 	%r688, %r685, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r689, %r674, %r688;
	mul.f32 	%r690, %r673, %r687;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r83, %r690, %r689;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs73, %rs74}, %r20;
	cvt.f32.bf16 	%r691, %rs73;
	cvt.f32.bf16 	%r692, %rs74;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs75, %rs76}, %r52;
	cvt.f32.bf16 	%r693, %rs75;
	cvt.f32.bf16 	%r694, %rs76;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r695, %r692, %r694;
	add.f32 	%r696, %r691, %r693;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r697, %r696, 0f3D372713;
	mul.f32 	%r698, %r695, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r699, %r696, %r697;
	mul.f32 	%r700, %r695, %r698;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r701, %r696, %r699, %r696;
	fma.rn.f32 	%r702, %r695, %r700, %r695;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r703, %r701, 0f3F4C422A;
	mul.f32 	%r704, %r702, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r705, %r695, 0f3F000000;
	mul.f32 	%r706, %r696, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r707, %r703, 0fC0000000;
	mul.f32 	%r708, %r704, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r709, %r707, 0f3FB8AA3B;
	ex2.approx.f32 	%r710, %r709;
	mul.f32 	%r711, %r708, 0f3FB8AA3B;
	ex2.approx.f32 	%r712, %r711;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r713, %r710, 0f3F800000;
	add.f32 	%r714, %r712, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r715, %r138, %r713;
	div.full.f32 	%r716, %r138, %r714;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r717, %r715, 0fBF800000;
	add.f32 	%r718, %r716, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r719, %r718, 0f3F800000;
	add.f32 	%r720, %r717, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r721, %r706, %r720;
	mul.f32 	%r722, %r705, %r719;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r84, %r722, %r721;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs77, %rs78}, %r21;
	cvt.f32.bf16 	%r723, %rs77;
	cvt.f32.bf16 	%r724, %rs78;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs79, %rs80}, %r53;
	cvt.f32.bf16 	%r725, %rs79;
	cvt.f32.bf16 	%r726, %rs80;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r727, %r724, %r726;
	add.f32 	%r728, %r723, %r725;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r729, %r728, 0f3D372713;
	mul.f32 	%r730, %r727, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r731, %r728, %r729;
	mul.f32 	%r732, %r727, %r730;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r733, %r728, %r731, %r728;
	fma.rn.f32 	%r734, %r727, %r732, %r727;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r735, %r733, 0f3F4C422A;
	mul.f32 	%r736, %r734, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r737, %r727, 0f3F000000;
	mul.f32 	%r738, %r728, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r739, %r735, 0fC0000000;
	mul.f32 	%r740, %r736, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r741, %r739, 0f3FB8AA3B;
	ex2.approx.f32 	%r742, %r741;
	mul.f32 	%r743, %r740, 0f3FB8AA3B;
	ex2.approx.f32 	%r744, %r743;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r745, %r742, 0f3F800000;
	add.f32 	%r746, %r744, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r747, %r138, %r745;
	div.full.f32 	%r748, %r138, %r746;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r749, %r747, 0fBF800000;
	add.f32 	%r750, %r748, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r751, %r750, 0f3F800000;
	add.f32 	%r752, %r749, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r753, %r738, %r752;
	mul.f32 	%r754, %r737, %r751;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r85, %r754, %r753;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs81, %rs82}, %r22;
	cvt.f32.bf16 	%r755, %rs81;
	cvt.f32.bf16 	%r756, %rs82;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs83, %rs84}, %r54;
	cvt.f32.bf16 	%r757, %rs83;
	cvt.f32.bf16 	%r758, %rs84;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r759, %r756, %r758;
	add.f32 	%r760, %r755, %r757;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r761, %r760, 0f3D372713;
	mul.f32 	%r762, %r759, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r763, %r760, %r761;
	mul.f32 	%r764, %r759, %r762;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r765, %r760, %r763, %r760;
	fma.rn.f32 	%r766, %r759, %r764, %r759;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r767, %r765, 0f3F4C422A;
	mul.f32 	%r768, %r766, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r769, %r759, 0f3F000000;
	mul.f32 	%r770, %r760, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r771, %r767, 0fC0000000;
	mul.f32 	%r772, %r768, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r773, %r771, 0f3FB8AA3B;
	ex2.approx.f32 	%r774, %r773;
	mul.f32 	%r775, %r772, 0f3FB8AA3B;
	ex2.approx.f32 	%r776, %r775;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r777, %r774, 0f3F800000;
	add.f32 	%r778, %r776, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r779, %r138, %r777;
	div.full.f32 	%r780, %r138, %r778;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r781, %r779, 0fBF800000;
	add.f32 	%r782, %r780, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r783, %r782, 0f3F800000;
	add.f32 	%r784, %r781, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r785, %r770, %r784;
	mul.f32 	%r786, %r769, %r783;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r86, %r786, %r785;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs85, %rs86}, %r23;
	cvt.f32.bf16 	%r787, %rs85;
	cvt.f32.bf16 	%r788, %rs86;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs87, %rs88}, %r55;
	cvt.f32.bf16 	%r789, %rs87;
	cvt.f32.bf16 	%r790, %rs88;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r791, %r788, %r790;
	add.f32 	%r792, %r787, %r789;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r793, %r792, 0f3D372713;
	mul.f32 	%r794, %r791, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r795, %r792, %r793;
	mul.f32 	%r796, %r791, %r794;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r797, %r792, %r795, %r792;
	fma.rn.f32 	%r798, %r791, %r796, %r791;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r799, %r797, 0f3F4C422A;
	mul.f32 	%r800, %r798, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r801, %r791, 0f3F000000;
	mul.f32 	%r802, %r792, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r803, %r799, 0fC0000000;
	mul.f32 	%r804, %r800, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r805, %r803, 0f3FB8AA3B;
	ex2.approx.f32 	%r806, %r805;
	mul.f32 	%r807, %r804, 0f3FB8AA3B;
	ex2.approx.f32 	%r808, %r807;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r809, %r806, 0f3F800000;
	add.f32 	%r810, %r808, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r811, %r138, %r809;
	div.full.f32 	%r812, %r138, %r810;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r813, %r811, 0fBF800000;
	add.f32 	%r814, %r812, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r815, %r814, 0f3F800000;
	add.f32 	%r816, %r813, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r817, %r802, %r816;
	mul.f32 	%r818, %r801, %r815;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r87, %r818, %r817;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs89, %rs90}, %r24;
	cvt.f32.bf16 	%r819, %rs89;
	cvt.f32.bf16 	%r820, %rs90;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs91, %rs92}, %r56;
	cvt.f32.bf16 	%r821, %rs91;
	cvt.f32.bf16 	%r822, %rs92;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r823, %r820, %r822;
	add.f32 	%r824, %r819, %r821;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r825, %r824, 0f3D372713;
	mul.f32 	%r826, %r823, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r827, %r824, %r825;
	mul.f32 	%r828, %r823, %r826;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r829, %r824, %r827, %r824;
	fma.rn.f32 	%r830, %r823, %r828, %r823;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r831, %r829, 0f3F4C422A;
	mul.f32 	%r832, %r830, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r833, %r823, 0f3F000000;
	mul.f32 	%r834, %r824, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r835, %r831, 0fC0000000;
	mul.f32 	%r836, %r832, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r837, %r835, 0f3FB8AA3B;
	ex2.approx.f32 	%r838, %r837;
	mul.f32 	%r839, %r836, 0f3FB8AA3B;
	ex2.approx.f32 	%r840, %r839;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r841, %r838, 0f3F800000;
	add.f32 	%r842, %r840, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r843, %r138, %r841;
	div.full.f32 	%r844, %r138, %r842;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r845, %r843, 0fBF800000;
	add.f32 	%r846, %r844, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r847, %r846, 0f3F800000;
	add.f32 	%r848, %r845, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r849, %r834, %r848;
	mul.f32 	%r850, %r833, %r847;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r88, %r850, %r849;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs93, %rs94}, %r25;
	cvt.f32.bf16 	%r851, %rs93;
	cvt.f32.bf16 	%r852, %rs94;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs95, %rs96}, %r57;
	cvt.f32.bf16 	%r853, %rs95;
	cvt.f32.bf16 	%r854, %rs96;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r855, %r852, %r854;
	add.f32 	%r856, %r851, %r853;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r857, %r856, 0f3D372713;
	mul.f32 	%r858, %r855, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r859, %r856, %r857;
	mul.f32 	%r860, %r855, %r858;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r861, %r856, %r859, %r856;
	fma.rn.f32 	%r862, %r855, %r860, %r855;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r863, %r861, 0f3F4C422A;
	mul.f32 	%r864, %r862, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r865, %r855, 0f3F000000;
	mul.f32 	%r866, %r856, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r867, %r863, 0fC0000000;
	mul.f32 	%r868, %r864, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r869, %r867, 0f3FB8AA3B;
	ex2.approx.f32 	%r870, %r869;
	mul.f32 	%r871, %r868, 0f3FB8AA3B;
	ex2.approx.f32 	%r872, %r871;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r873, %r870, 0f3F800000;
	add.f32 	%r874, %r872, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r875, %r138, %r873;
	div.full.f32 	%r876, %r138, %r874;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r877, %r875, 0fBF800000;
	add.f32 	%r878, %r876, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r879, %r878, 0f3F800000;
	add.f32 	%r880, %r877, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r881, %r866, %r880;
	mul.f32 	%r882, %r865, %r879;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r89, %r882, %r881;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs97, %rs98}, %r26;
	cvt.f32.bf16 	%r883, %rs97;
	cvt.f32.bf16 	%r884, %rs98;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs99, %rs100}, %r58;
	cvt.f32.bf16 	%r885, %rs99;
	cvt.f32.bf16 	%r886, %rs100;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r887, %r884, %r886;
	add.f32 	%r888, %r883, %r885;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r889, %r888, 0f3D372713;
	mul.f32 	%r890, %r887, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r891, %r888, %r889;
	mul.f32 	%r892, %r887, %r890;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r893, %r888, %r891, %r888;
	fma.rn.f32 	%r894, %r887, %r892, %r887;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r895, %r893, 0f3F4C422A;
	mul.f32 	%r896, %r894, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r897, %r887, 0f3F000000;
	mul.f32 	%r898, %r888, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r899, %r895, 0fC0000000;
	mul.f32 	%r900, %r896, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r901, %r899, 0f3FB8AA3B;
	ex2.approx.f32 	%r902, %r901;
	mul.f32 	%r903, %r900, 0f3FB8AA3B;
	ex2.approx.f32 	%r904, %r903;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r905, %r902, 0f3F800000;
	add.f32 	%r906, %r904, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r907, %r138, %r905;
	div.full.f32 	%r908, %r138, %r906;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r909, %r907, 0fBF800000;
	add.f32 	%r910, %r908, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r911, %r910, 0f3F800000;
	add.f32 	%r912, %r909, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r913, %r898, %r912;
	mul.f32 	%r914, %r897, %r911;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r90, %r914, %r913;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs101, %rs102}, %r27;
	cvt.f32.bf16 	%r915, %rs101;
	cvt.f32.bf16 	%r916, %rs102;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs103, %rs104}, %r59;
	cvt.f32.bf16 	%r917, %rs103;
	cvt.f32.bf16 	%r918, %rs104;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r919, %r916, %r918;
	add.f32 	%r920, %r915, %r917;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r921, %r920, 0f3D372713;
	mul.f32 	%r922, %r919, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r923, %r920, %r921;
	mul.f32 	%r924, %r919, %r922;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r925, %r920, %r923, %r920;
	fma.rn.f32 	%r926, %r919, %r924, %r919;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r927, %r925, 0f3F4C422A;
	mul.f32 	%r928, %r926, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r929, %r919, 0f3F000000;
	mul.f32 	%r930, %r920, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r931, %r927, 0fC0000000;
	mul.f32 	%r932, %r928, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r933, %r931, 0f3FB8AA3B;
	ex2.approx.f32 	%r934, %r933;
	mul.f32 	%r935, %r932, 0f3FB8AA3B;
	ex2.approx.f32 	%r936, %r935;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r937, %r934, 0f3F800000;
	add.f32 	%r938, %r936, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r939, %r138, %r937;
	div.full.f32 	%r940, %r138, %r938;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r941, %r939, 0fBF800000;
	add.f32 	%r942, %r940, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r943, %r942, 0f3F800000;
	add.f32 	%r944, %r941, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r945, %r930, %r944;
	mul.f32 	%r946, %r929, %r943;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r91, %r946, %r945;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs105, %rs106}, %r28;
	cvt.f32.bf16 	%r947, %rs105;
	cvt.f32.bf16 	%r948, %rs106;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs107, %rs108}, %r60;
	cvt.f32.bf16 	%r949, %rs107;
	cvt.f32.bf16 	%r950, %rs108;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r951, %r948, %r950;
	add.f32 	%r952, %r947, %r949;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r953, %r952, 0f3D372713;
	mul.f32 	%r954, %r951, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r955, %r952, %r953;
	mul.f32 	%r956, %r951, %r954;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r957, %r952, %r955, %r952;
	fma.rn.f32 	%r958, %r951, %r956, %r951;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r959, %r957, 0f3F4C422A;
	mul.f32 	%r960, %r958, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r961, %r951, 0f3F000000;
	mul.f32 	%r962, %r952, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r963, %r959, 0fC0000000;
	mul.f32 	%r964, %r960, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r965, %r963, 0f3FB8AA3B;
	ex2.approx.f32 	%r966, %r965;
	mul.f32 	%r967, %r964, 0f3FB8AA3B;
	ex2.approx.f32 	%r968, %r967;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r969, %r966, 0f3F800000;
	add.f32 	%r970, %r968, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r971, %r138, %r969;
	div.full.f32 	%r972, %r138, %r970;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r973, %r971, 0fBF800000;
	add.f32 	%r974, %r972, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r975, %r974, 0f3F800000;
	add.f32 	%r976, %r973, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r977, %r962, %r976;
	mul.f32 	%r978, %r961, %r975;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r92, %r978, %r977;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs109, %rs110}, %r29;
	cvt.f32.bf16 	%r979, %rs109;
	cvt.f32.bf16 	%r980, %rs110;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs111, %rs112}, %r61;
	cvt.f32.bf16 	%r981, %rs111;
	cvt.f32.bf16 	%r982, %rs112;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r983, %r980, %r982;
	add.f32 	%r984, %r979, %r981;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r985, %r984, 0f3D372713;
	mul.f32 	%r986, %r983, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r987, %r984, %r985;
	mul.f32 	%r988, %r983, %r986;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r989, %r984, %r987, %r984;
	fma.rn.f32 	%r990, %r983, %r988, %r983;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r991, %r989, 0f3F4C422A;
	mul.f32 	%r992, %r990, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r993, %r983, 0f3F000000;
	mul.f32 	%r994, %r984, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r995, %r991, 0fC0000000;
	mul.f32 	%r996, %r992, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r997, %r995, 0f3FB8AA3B;
	ex2.approx.f32 	%r998, %r997;
	mul.f32 	%r999, %r996, 0f3FB8AA3B;
	ex2.approx.f32 	%r1000, %r999;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r1001, %r998, 0f3F800000;
	add.f32 	%r1002, %r1000, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r1003, %r138, %r1001;
	div.full.f32 	%r1004, %r138, %r1002;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r1005, %r1003, 0fBF800000;
	add.f32 	%r1006, %r1004, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r1007, %r1006, 0f3F800000;
	add.f32 	%r1008, %r1005, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r1009, %r994, %r1008;
	mul.f32 	%r1010, %r993, %r1007;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r93, %r1010, %r1009;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs113, %rs114}, %r30;
	cvt.f32.bf16 	%r1011, %rs113;
	cvt.f32.bf16 	%r1012, %rs114;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs115, %rs116}, %r62;
	cvt.f32.bf16 	%r1013, %rs115;
	cvt.f32.bf16 	%r1014, %rs116;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r1015, %r1012, %r1014;
	add.f32 	%r1016, %r1011, %r1013;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r1017, %r1016, 0f3D372713;
	mul.f32 	%r1018, %r1015, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r1019, %r1016, %r1017;
	mul.f32 	%r1020, %r1015, %r1018;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r1021, %r1016, %r1019, %r1016;
	fma.rn.f32 	%r1022, %r1015, %r1020, %r1015;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r1023, %r1021, 0f3F4C422A;
	mul.f32 	%r1024, %r1022, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r1025, %r1015, 0f3F000000;
	mul.f32 	%r1026, %r1016, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r1027, %r1023, 0fC0000000;
	mul.f32 	%r1028, %r1024, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r1029, %r1027, 0f3FB8AA3B;
	ex2.approx.f32 	%r1030, %r1029;
	mul.f32 	%r1031, %r1028, 0f3FB8AA3B;
	ex2.approx.f32 	%r1032, %r1031;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r1033, %r1030, 0f3F800000;
	add.f32 	%r1034, %r1032, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r1035, %r138, %r1033;
	div.full.f32 	%r1036, %r138, %r1034;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r1037, %r1035, 0fBF800000;
	add.f32 	%r1038, %r1036, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r1039, %r1038, 0f3F800000;
	add.f32 	%r1040, %r1037, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r1041, %r1026, %r1040;
	mul.f32 	%r1042, %r1025, %r1039;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r94, %r1042, %r1041;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs117, %rs118}, %r31;
	cvt.f32.bf16 	%r1043, %rs117;
	cvt.f32.bf16 	%r1044, %rs118;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs119, %rs120}, %r63;
	cvt.f32.bf16 	%r1045, %rs119;
	cvt.f32.bf16 	%r1046, %rs120;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r1047, %r1044, %r1046;
	add.f32 	%r1048, %r1043, %r1045;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r1049, %r1048, 0f3D372713;
	mul.f32 	%r1050, %r1047, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r1051, %r1048, %r1049;
	mul.f32 	%r1052, %r1047, %r1050;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r1053, %r1048, %r1051, %r1048;
	fma.rn.f32 	%r1054, %r1047, %r1052, %r1047;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r1055, %r1053, 0f3F4C422A;
	mul.f32 	%r1056, %r1054, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r1057, %r1047, 0f3F000000;
	mul.f32 	%r1058, %r1048, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r1059, %r1055, 0fC0000000;
	mul.f32 	%r1060, %r1056, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r1061, %r1059, 0f3FB8AA3B;
	ex2.approx.f32 	%r1062, %r1061;
	mul.f32 	%r1063, %r1060, 0f3FB8AA3B;
	ex2.approx.f32 	%r1064, %r1063;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r1065, %r1062, 0f3F800000;
	add.f32 	%r1066, %r1064, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r1067, %r138, %r1065;
	div.full.f32 	%r1068, %r138, %r1066;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r1069, %r1067, 0fBF800000;
	add.f32 	%r1070, %r1068, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r1071, %r1070, 0f3F800000;
	add.f32 	%r1072, %r1069, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r1073, %r1058, %r1072;
	mul.f32 	%r1074, %r1057, %r1071;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r95, %r1074, %r1073;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs121, %rs122}, %r32;
	cvt.f32.bf16 	%r1075, %rs121;
	cvt.f32.bf16 	%r1076, %rs122;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs123, %rs124}, %r64;
	cvt.f32.bf16 	%r1077, %rs123;
	cvt.f32.bf16 	%r1078, %rs124;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r1079, %r1076, %r1078;
	add.f32 	%r1080, %r1075, %r1077;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r1081, %r1080, 0f3D372713;
	mul.f32 	%r1082, %r1079, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r1083, %r1080, %r1081;
	mul.f32 	%r1084, %r1079, %r1082;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r1085, %r1080, %r1083, %r1080;
	fma.rn.f32 	%r1086, %r1079, %r1084, %r1079;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r1087, %r1085, 0f3F4C422A;
	mul.f32 	%r1088, %r1086, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r1089, %r1079, 0f3F000000;
	mul.f32 	%r1090, %r1080, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r1091, %r1087, 0fC0000000;
	mul.f32 	%r1092, %r1088, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r1093, %r1091, 0f3FB8AA3B;
	ex2.approx.f32 	%r1094, %r1093;
	mul.f32 	%r1095, %r1092, 0f3FB8AA3B;
	ex2.approx.f32 	%r1096, %r1095;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r1097, %r1094, 0f3F800000;
	add.f32 	%r1098, %r1096, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r1099, %r138, %r1097;
	div.full.f32 	%r1100, %r138, %r1098;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r1101, %r1099, 0fBF800000;
	add.f32 	%r1102, %r1100, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r1103, %r1102, 0f3F800000;
	add.f32 	%r1104, %r1101, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r1105, %r1090, %r1104;
	mul.f32 	%r1106, %r1089, %r1103;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r96, %r1106, %r1105;
	.loc	1 114 73                        // sk11_vision.py:114:73
	mov.b32 	{%rs125, %rs126}, %r33;
	cvt.f32.bf16 	%r1107, %rs125;
	cvt.f32.bf16 	%r1108, %rs126;
	.loc	1 115 59                        // sk11_vision.py:115:59
	mov.b32 	{%rs127, %rs128}, %r65;
	cvt.f32.bf16 	%r1109, %rs127;
	cvt.f32.bf16 	%r1110, %rs128;
	.loc	1 115 9                         // sk11_vision.py:115:9
	add.f32 	%r1111, %r1108, %r1110;
	add.f32 	%r1112, %r1107, %r1109;
	.loc	1 116 49                        // sk11_vision.py:116:49
	mul.f32 	%r1113, %r1112, 0f3D372713;
	mul.f32 	%r1114, %r1111, 0f3D372713;
	.loc	1 116 53                        // sk11_vision.py:116:53
	mul.f32 	%r1115, %r1112, %r1113;
	mul.f32 	%r1116, %r1111, %r1114;
	.loc	1 116 38                        // sk11_vision.py:116:38
	fma.rn.f32 	%r1117, %r1112, %r1115, %r1112;
	fma.rn.f32 	%r1118, %r1111, %r1116, %r1111;
	.loc	1 116 34                        // sk11_vision.py:116:34
	mul.f32 	%r1119, %r1117, 0f3F4C422A;
	mul.f32 	%r1120, %r1118, 0f3F4C422A;
	.loc	1 117 14                        // sk11_vision.py:117:14
	mul.f32 	%r1121, %r1111, 0f3F000000;
	mul.f32 	%r1122, %r1112, 0f3F000000;
	.loc	1 117 53                        // sk11_vision.py:117:53
	mul.f32 	%r1123, %r1119, 0fC0000000;
	mul.f32 	%r1124, %r1120, 0fC0000000;
	.loc	1 117 46                        // sk11_vision.py:117:46
	mul.f32 	%r1125, %r1123, 0f3FB8AA3B;
	ex2.approx.f32 	%r1126, %r1125;
	mul.f32 	%r1127, %r1124, 0f3FB8AA3B;
	ex2.approx.f32 	%r1128, %r1127;
	.loc	1 117 39                        // sk11_vision.py:117:39
	add.f32 	%r1129, %r1126, 0f3F800000;
	add.f32 	%r1130, %r1128, 0f3F800000;
	.loc	1 117 33                        // sk11_vision.py:117:33
	div.full.f32 	%r1131, %r138, %r1129;
	div.full.f32 	%r1132, %r138, %r1130;
	.loc	1 117 63                        // sk11_vision.py:117:63
	add.f32 	%r1133, %r1131, 0fBF800000;
	add.f32 	%r1134, %r1132, 0fBF800000;
	.loc	1 117 26                        // sk11_vision.py:117:26
	add.f32 	%r1135, %r1134, 0f3F800000;
	add.f32 	%r1136, %r1133, 0f3F800000;
	.loc	1 117 19                        // sk11_vision.py:117:19
	mul.f32 	%r1137, %r1122, %r1136;
	mul.f32 	%r1138, %r1121, %r1135;
	.loc	1 118 52                        // sk11_vision.py:118:52
	cvt.rn.bf16x2.f32 	%r97, %r1138, %r1137;
	.loc	1 118 47                        // sk11_vision.py:118:47
	// begin inline asm
	@%p1 st.global.v4.b32 [ %rd17 + 0 ], { %r66, %r67, %r68, %r69 };
	// end inline asm
	// begin inline asm
	@%p2 st.global.v4.b32 [ %rd18 + 0 ], { %r70, %r71, %r72, %r73 };
	// end inline asm
	// begin inline asm
	@%p3 st.global.v4.b32 [ %rd19 + 0 ], { %r74, %r75, %r76, %r77 };
	// end inline asm
	// begin inline asm
	@%p4 st.global.v4.b32 [ %rd20 + 0 ], { %r78, %r79, %r80, %r81 };
	// end inline asm
	// begin inline asm
	@%p5 st.global.v4.b32 [ %rd21 + 0 ], { %r82, %r83, %r84, %r85 };
	// end inline asm
	// begin inline asm
	@%p6 st.global.v4.b32 [ %rd22 + 0 ], { %r86, %r87, %r88, %r89 };
	// end inline asm
	// begin inline asm
	@%p7 st.global.v4.b32 [ %rd23 + 0 ], { %r90, %r91, %r92, %r93 };
	// end inline asm
	// begin inline asm
	@%p8 st.global.v4.b32 [ %rd24 + 0 ], { %r94, %r95, %r96, %r97 };
	// end inline asm
	.loc	1 118 4                         // sk11_vision.py:118:4
	ret;
$L__tmp1:
...
_QVAR0_3 = _Nativo(
    "sk11_vision/_sk11_bias_gelu_kernel/blk16384",
    _QPTX0_3, "_sk11_bias_gelu_kernel",
    warps=8, shared=0,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 16384},
    div16=[3, 4, 5],
...
def _q0_impl(grid: list[int], x_ptr: torch.Tensor, bias_ptr: torch.Tensor, out_ptr: torch.Tensor, N: int, stride_xm: int, stride_om: int, BLOCK: int) -> None:
    ...
    args = (x_ptr, bias_ptr, out_ptr, N, stride_xm, stride_om, BLOCK)
    for _v in _POR_Q0:
        if all(args[_p] == _x for _p, _x in _v.horneado.items()):
            return _v(tuple(grid), *args)
    raise ValueError(
        "genesis_sk11_vision_q0: no hay PTX embebido para estos constexpr; "
...
if not hasattr(torch.ops.vllm, "genesis_sk11_vision_q0"):
