...
# --- quant _sk04_fa_o_w4a8_quant_kernel: 4 variante(s) de PTX embebido ---
...
.reqntid 256
{
	...
	.reg .b32 	%r<125>;
	.reg .b64 	%rd<11>;
	.loc	1 724 0                         // sk04_fa_o_w4a8.py:724:0
$L__func_begin0:
	.loc	1 724 0                         // sk04_fa_o_w4a8.py:724:0

// %bb.0:
	ld.param.b64 	%rd4, [_sk04_fa_o_w4a8_quant_kernel_param_0];
	ld.param.b64 	%rd5, [_sk04_fa_o_w4a8_quant_kernel_param_1];
$L__tmp0:
	.loc	1 726 24                        // sk04_fa_o_w4a8.py:726:24
	mov.u32 	%r14, %ctaid.x;
	ld.param.b64 	%rd6, [_sk04_fa_o_w4a8_quant_kernel_param_2];
	.loc	1 727 24                        // sk04_fa_o_w4a8.py:727:24
	mov.u32 	%r15, %tid.x;
	and.b32 	%r16, %r15, 255;
	ld.param.b32 	%r17, [_sk04_fa_o_w4a8_quant_kernel_param_3];
	and.b32 	%r18, %r15, 31;
	ld.param.b32 	%r19, [_sk04_fa_o_w4a8_quant_kernel_param_4];
	shr.u32 	%r20, %r15, 5;
	ld.param.b32 	%r21, [_sk04_fa_o_w4a8_quant_kernel_param_5];
	shl.b32 	%r22, %r15, 3;
	and.b32 	%r23, %r22, 2040;
	.loc	1 728 18                        // sk04_fa_o_w4a8.py:728:18
	setp.lt.s32 	%p1, %r23, %r17;
	.loc	1 729 30                        // sk04_fa_o_w4a8.py:729:30
	mul.lo.s32 	%r24, %r19, %r14;
	.loc	1 729 24                        // sk04_fa_o_w4a8.py:729:24
	mad.wide.s32 	%rd7, %r24, 2, %rd4;
	.loc	1 729 42                        // sk04_fa_o_w4a8.py:729:42
	cvt.u64.u32 	%rd8, %r23;
	mad.wide.u32 	%rd1, %r23, 2, %rd7;
	mov.b32 	%r5, 0;
	.loc	1 729 16                        // sk04_fa_o_w4a8.py:729:16
	// begin inline asm
	mov.u32 %r1, %r5;
	mov.u32 %r2, %r5;
	mov.u32 %r3, %r5;
	...
	// end inline asm
$L__tmp1:
	.loc	2 191 40                        // standard.py:191:40 @[ sk04_fa_o_w4a8.py:730:29 ]
	...
	and.pred 	%p4, %p3, %p6;
$L__tmp2:
	.loc	1 733 27                        // sk04_fa_o_w4a8.py:733:27
	mul.lo.s32 	%r30, %r21, %r14;
	.loc	1 733 21                        // sk04_fa_o_w4a8.py:733:21
	cvt.s64.s32 	%rd9, %r30;
	add.s64 	%rd10, %rd5, %rd9;
	.loc	1 733 39                        // sk04_fa_o_w4a8.py:733:39
	add.s64 	%rd2, %rd10, %rd8;
	.loc	1 729 73                        // sk04_fa_o_w4a8.py:729:73
	mov.b32 	{%rs1, %rs2}, %r4;
	...
	.loc	1 730 36                        // sk04_fa_o_w4a8.py:730:36
	abs.f32 	%r35, %r34;
	abs.f32 	%r36, %r33;
	abs.f32 	%r37, %r32;
	abs.f32 	%r38, %r31;
	...
	abs.f32 	%r46, %r39;
$L__tmp3:
	.loc	2 170 27                        // standard.py:170:27 @[ standard.py:191:40 @[ sk04_fa_o_w4a8.py:730:29 ] ]
	max.f32 	%r47, %r43, %r44;
	max.f32 	%r48, %r47, %r45;
	max.f32 	%r49, %r48, %r46;
	max.f32 	%r50, %r49, %r35;
...
$L__tmp21:
	.loc	1 730 49                        // sk04_fa_o_w4a8.py:730:49
	max.f32 	%r69, %r68, 0f0DA24260;
	mov.b32 	%r70, 0f42FE0000;
	.loc	1 731 22                        // sk04_fa_o_w4a8.py:731:22
	div.full.f32 	%r71, %r70, %r69;
	.loc	1 731 14                        // sk04_fa_o_w4a8.py:731:14
	mul.f32 	%r72, %r71, %r41;
	mul.f32 	%r73, %r71, %r42;
	mul.f32 	%r74, %r71, %r39;
	mul.f32 	%r75, %r71, %r40;
	...
	mul.f32 	%r78, %r71, %r31;
	mul.f32 	%r79, %r71, %r32;
	.loc	1 732 29                        // sk04_fa_o_w4a8.py:732:29
	.loc	1 732 39                        // sk04_fa_o_w4a8.py:732:39
	...
	.loc	1 732 14                        // sk04_fa_o_w4a8.py:732:14
	...
	.loc	1 732 49                        // sk04_fa_o_w4a8.py:732:49
	...
	.loc	1 733 70                        // sk04_fa_o_w4a8.py:733:70
	...
	.loc	1 733 77                        // sk04_fa_o_w4a8.py:733:77
	...
	.loc	1 733 85                        // sk04_fa_o_w4a8.py:733:85
	...
	.loc	1 733 45                        // sk04_fa_o_w4a8.py:733:45
	// begin inline asm
	@%p1 st.global.v2.b32 [ %rd2 + 0 ], { %r11, %r12 };
	// end inline asm
	.loc	1 734 21                        // sk04_fa_o_w4a8.py:734:21
	mad.wide.u32 	%rd3, %r14, 4, %rd6;
	.loc	1 734 34                        // sk04_fa_o_w4a8.py:734:34
	mul.f32 	%r13, %r69, 0f3C010204;
	.loc	1 734 26                        // sk04_fa_o_w4a8.py:734:26
	or.b32 	%r124, %r18, %r20;
	setp.eq.b32 	%p5, %r124, 0;
	// begin inline asm
	@%p5 st.global.b32 [ %rd3 + 0 ], { %r13 };
	// end inline asm
	.loc	1 734 4                         // sk04_fa_o_w4a8.py:734:4
	ret;
$L__tmp22:
$L__func_end0:
                                        // -- End function
...
.b8 115
.b8 0
.b8 2                                   // Abbrev [2] 0x47:0x1f DW_TAG_subprogram
.b8 95                                  // DW_AT_name
.b8 115
.b8 107
.b8 48
...
.b8 0
.b8 1                                   // DW_AT_inline
.b8 3                                   // Abbrev [3] 0x66:0x48 DW_TAG_subprogram
.b64 $L__func_begin0                    // DW_AT_low_pc
.b64 $L__func_end0                      // DW_AT_high_pc
.b32 71                                 // DW_AT_abstract_origin
.b8 4                                   // Abbrev [4] 0x7b:0x32 DW_TAG_inlined_subroutine
.b32 71                                 // DW_AT_abstract_origin
.b64 $L__tmp1                           // DW_AT_low_pc
...
.b8 5                                   // Abbrev [5] 0x94:0x18 DW_TAG_inlined_subroutine
.b32 71                                 // DW_AT_abstract_origin
...
_QVAR0_0 = _Nativo(
    "sk04_fa_o_w4a8/_sk04_fa_o_w4a8_quant_kernel/blk2048",
    _QPTX0_0, "_sk04_fa_o_w4a8_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 2048},
    div16=[3, 4, 5],
...
_QVAR0_1 = _Nativo(
    "sk04_fa_o_w4a8/_sk04_fa_o_w4a8_quant_kernel/blk4096",
    _QPTX0_1, "_sk04_fa_o_w4a8_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 4096},
    div16=[3, 4, 5],
...
// %bb.0:
	ld.param.b64 	%rd8, [_sk04_fa_o_w4a8_quant_kernel_param_0];
	ld.param.b64 	%rd9, [_sk04_fa_o_w4a8_quant_kernel_param_1];
$L__tmp0:
	.loc	1 726 24                        // sk04_fa_o_w4a8.py:726:24
	mov.u32 	%r32, %ctaid.x;
	ld.param.b64 	%rd10, [_sk04_fa_o_w4a8_quant_kernel_param_2];
	.loc	1 727 24                        // sk04_fa_o_w4a8.py:727:24
	mov.u32 	%r33, %tid.x;
	and.b32 	%r34, %r33, 255;
	ld.param.b32 	%r35, [_sk04_fa_o_w4a8_quant_kernel_param_3];
	and.b32 	%r36, %r33, 31;
	ld.param.b32 	%r37, [_sk04_fa_o_w4a8_quant_kernel_param_4];
	shr.u32 	%r38, %r33, 5;
	ld.param.b32 	%r39, [_sk04_fa_o_w4a8_quant_kernel_param_5];
	shl.b32 	%r40, %r33, 4;
...
_QVAR0_2 = _Nativo(
    "sk04_fa_o_w4a8/_sk04_fa_o_w4a8_quant_kernel/blk8192",
    _QPTX0_2, "_sk04_fa_o_w4a8_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 8192},
    div16=[3, 4, 5],
...
// %bb.0:
	ld.param.b64 	%rd14, [_sk04_fa_o_w4a8_quant_kernel_param_0];
	ld.param.b64 	%rd15, [_sk04_fa_o_w4a8_quant_kernel_param_1];
$L__tmp0:
	.loc	1 726 24                        // sk04_fa_o_w4a8.py:726:24
	mov.u32 	%r56, %ctaid.x;
	ld.param.b64 	%rd16, [_sk04_fa_o_w4a8_quant_kernel_param_2];
	.loc	1 727 24                        // sk04_fa_o_w4a8.py:727:24
	mov.u32 	%r57, %tid.x;
	and.b32 	%r58, %r57, 255;
	ld.param.b32 	%r59, [_sk04_fa_o_w4a8_quant_kernel_param_3];
	and.b32 	%r60, %r57, 31;
	ld.param.b32 	%r61, [_sk04_fa_o_w4a8_quant_kernel_param_4];
	shr.u32 	%r62, %r57, 5;
	ld.param.b32 	%r63, [_sk04_fa_o_w4a8_quant_kernel_param_5];
	shl.b32 	%r64, %r57, 4;
...
_QVAR0_3 = _Nativo(
    "sk04_fa_o_w4a8/_sk04_fa_o_w4a8_quant_kernel/blk16384",
    _QPTX0_3, "_sk04_fa_o_w4a8_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 16384},
    div16=[3, 4, 5],
...
def _q0_impl(grid: list[int], x_ptr: torch.Tensor, q_ptr: torch.Tensor, s_ptr: torch.Tensor, K: int, stride_xm: int, stride_qm: int, BLOCK: int) -> None:
    ...
    raise ValueError(
        "genesis_sk04_fa_o_w4a8_q0: no hay PTX embebido para estos constexpr; "
...
if not hasattr(torch.ops.vllm, "genesis_sk04_fa_o_w4a8_q0"):
    from vllm.utils.torch_utils import direct_register_custom_op
    direct_register_custom_op(
        op_name="genesis_sk04_fa_o_w4a8_q0",
        op_func=_q0_impl,
...
def _lanzar_quant0(grid, *args):
    ...
    return torch.ops.vllm.genesis_sk04_fa_o_w4a8_q0(g, *args)
