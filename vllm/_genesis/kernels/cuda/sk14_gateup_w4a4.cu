...
//
// SK-14 — copia de SK-12 con la instruccion conmutable s8 m16n8k32 / s4 m16n8k64.
//
// El layout de fragmentos por registro es IDENTICO en las dos (medido con sondas,
// ver kernels/mma_layout.py), asi que la logica de carga de SK-12 sirve tal cual:
// con S4=1 cada byte del shared trae DOS nibbles y cada mma consume k64 elementos
// en lugar de k32. K se pasa en BYTES por fila (K_elem/2 en s4).
#ifndef S4
#define S4 0
#endif
#if S4
...
#else
#define SK14_MMA_OP "mma.sync.aligned.m16n8k32.row.col.satfinite.s32.s8.s8.s32 "
#endif
// SPDX-License-Identifier: Apache-2.0
//
