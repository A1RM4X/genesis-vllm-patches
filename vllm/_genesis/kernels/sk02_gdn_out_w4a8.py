...
.reqntid 256
{
	...
	.reg .b32 	%r<207>;
	.reg .b64 	%rd<12>;
	.loc	1 113 0                         // sk02_gdn_out_w4a8.py:113:0
$L__func_begin0:
	.loc	1 113 0                         // sk02_gdn_out_w4a8.py:113:0
...
$L__tmp0:
	.loc	1 115 24                        // sk02_gdn_out_w4a8.py:115:24
	mov.u32 	%r20, %ctaid.x;
	ld.param.b64 	%rd7, [_sk02_gdn_out_w4a8_quant_kernel_param_2];
	.loc	1 116 24                        // sk02_gdn_out_w4a8.py:116:24
	mov.u32 	%r21, %tid.x;
	and.b32 	%r22, %r21, 255;
	...
	.loc	1 117 18                        // sk02_gdn_out_w4a8.py:117:18
	setp.lt.s32 	%p1, %r29, %r23;
	.loc	1 118 30                        // sk02_gdn_out_w4a8.py:118:30
	mul.lo.s32 	%r30, %r25, %r20;
	.loc	1 118 24                        // sk02_gdn_out_w4a8.py:118:24
	mad.wide.s32 	%rd8, %r30, 2, %rd5;
	.loc	1 118 42                        // sk02_gdn_out_w4a8.py:118:42
	cvt.u64.u32 	%rd9, %r29;
	mad.wide.u32 	%rd1, %r29, 2, %rd8;
	add.s64 	%rd2, %rd1, 16;
	mov.b32 	%r5, 0;
	.loc	1 118 16                        // sk02_gdn_out_w4a8.py:118:16
	// begin inline asm
	mov.u32 %r1, %r5;
	mov.u32 %r2, %r5;
	mov.u32 %r3, %r5;
	...
	// end inline asm
$L__tmp1:
	.loc	2 191 40                        // standard.py:191:40 @[ sk02_gdn_out_w4a8.py:119:29 ]
	...
	and.pred 	%p4, %p3, %p6;
$L__tmp2:
	.loc	1 122 27                        // sk02_gdn_out_w4a8.py:122:27
	mul.lo.s32 	%r36, %r27, %r20;
	.loc	1 122 21                        // sk02_gdn_out_w4a8.py:122:21
	cvt.s64.s32 	%rd10, %r36;
	add.s64 	%rd11, %rd6, %rd10;
	.loc	1 122 39                        // sk02_gdn_out_w4a8.py:122:39
	add.s64 	%rd3, %rd11, %rd9;
	.loc	1 118 73                        // sk02_gdn_out_w4a8.py:118:73
	mov.b32 	{%rs1, %rs2}, %r9;
	...
	.loc	1 119 36                        // sk02_gdn_out_w4a8.py:119:36
	abs.f32 	%r41, %r40;
	abs.f32 	%r42, %r39;
	abs.f32 	%r43, %r38;
	abs.f32 	%r44, %r37;
	...
	abs.f32 	%r68, %r61;
$L__tmp3:
	.loc	2 170 27                        // standard.py:170:27 @[ standard.py:191:40 @[ sk02_gdn_out_w4a8.py:119:29 ] ]
	max.f32 	%r69, %r65, %r66;
	max.f32 	%r70, %r69, %r67;
	max.f32 	%r71, %r70, %r68;
	max.f32 	%r72, %r71, %r57;
...
$L__tmp21:
	.loc	1 119 49                        // sk02_gdn_out_w4a8.py:119:49
	max.f32 	%r99, %r98, 0f0DA24260;
	mov.b32 	%r100, 0f42FE0000;
	.loc	1 120 22                        // sk02_gdn_out_w4a8.py:120:22
	div.full.f32 	%r101, %r100, %r99;
	.loc	1 120 14                        // sk02_gdn_out_w4a8.py:120:14
	...
	.loc	1 121 29                        // sk02_gdn_out_w4a8.py:121:29
	.loc	1 121 39                        // sk02_gdn_out_w4a8.py:121:39
	...
	.loc	1 121 14                        // sk02_gdn_out_w4a8.py:121:14
	...
	.loc	1 121 49                        // sk02_gdn_out_w4a8.py:121:49
	...
	.loc	1 122 70                        // sk02_gdn_out_w4a8.py:122:70
	...
	.loc	1 122 77                        // sk02_gdn_out_w4a8.py:122:77
	...
	.loc	1 122 85                        // sk02_gdn_out_w4a8.py:122:85
	...
	.loc	1 122 45                        // sk02_gdn_out_w4a8.py:122:45
	// begin inline asm
	@%p1 st.global.v4.b32 [ %rd3 + 0 ], { %r15, %r16, %r17, %r18 };
	// end inline asm
	.loc	1 123 21                        // sk02_gdn_out_w4a8.py:123:21
	mad.wide.u32 	%rd4, %r20, 4, %rd7;
	.loc	1 123 34                        // sk02_gdn_out_w4a8.py:123:34
	mul.f32 	%r19, %r99, 0f3C010204;
	.loc	1 123 26                        // sk02_gdn_out_w4a8.py:123:26
	or.b32 	%r206, %r24, %r26;
	setp.eq.b32 	%p5, %r206, 0;
	// begin inline asm
	@%p5 st.global.b32 [ %rd4 + 0 ], { %r19 };
	// end inline asm
	.loc	1 123 4                         // sk02_gdn_out_w4a8.py:123:4
	ret;
$L__tmp22:
$L__func_end0:
                                        // -- End function
}
	.file	1 "/home/usuario/Proyectos/genesis-vllm-patches/vllm/_genesis/kernels/sk02_gdn_out_w4a8.py"
...
.b8 115
.b8 0
.b8 2                                   // Abbrev [2] 0x71:0x22 DW_TAG_subprogram
.b8 95                                  // DW_AT_name
.b8 115
.b8 107
.b8 48
...
.b8 0
.b8 1                                   // DW_AT_inline
.b8 3                                   // Abbrev [3] 0x93:0x47 DW_TAG_subprogram
.b64 $L__func_begin0                    // DW_AT_low_pc
.b64 $L__func_end0                      // DW_AT_high_pc
.b32 113                                // DW_AT_abstract_origin
...
.b8 5                                   // Abbrev [5] 0xc0:0x18 DW_TAG_inlined_subroutine
.b32 113                                // DW_AT_abstract_origin
...
_PTX_KERNEL = _Nativo(
    'B2/sk02_gdn_out_w4a8.py__quant',
    _PTX_QUANT, '_sk02_gdn_out_w4a8_quant_kernel',
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 4096},
    div16=[],
