...
_PTX_KERNEL_SK05_RMSNORM_QUANT = _Nativo(
    'B2/sk05_mlp_gateup_w4a8.py__rmsnorm_quant',
    _PTX_SRC_SK05_RMSNORM_QUANT, '_sk05_mlp_gateup_w4a8_rmsnorm_quant_kernel',
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5, 6],
...
_PTX_KERNEL_SK05_SILU_MUL_QUANT = _Nativo(
    'B2/sk05_mlp_gateup_w4a8.py__silu_mul_quant',
    _PTX_SRC_SK05_SILU_MUL_QUANT, '_sk05_mlp_gateup_w4a8_silu_mul_quant_kernel',
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 16384},
    div16=[],
