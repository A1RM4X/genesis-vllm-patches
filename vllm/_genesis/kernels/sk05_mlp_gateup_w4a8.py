...
_QVAR0 = _Nativo(
    "sk05_mlp_gateup_w4a8/_sk05_mlp_gateup_w4a8_rmsnorm_quant_kernel",
    _QPTX0, "_sk05_mlp_gateup_w4a8_rmsnorm_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5, 6],
...
_QVAR1 = _Nativo(
    "sk05_mlp_gateup_w4a8/_sk05_mlp_gateup_w4a8_silu_mul_quant_kernel",
    _QPTX1, "_sk05_mlp_gateup_w4a8_silu_mul_quant_kernel",
    warps=8, shared=32,
    abi=[0, 1, 2, 3, 4, 5],
    horneado={6: 8192},
    div16=[3, 4, 5],
...
def _q1_impl(grid: list[int], gu_ptr: torch.Tensor, q_ptr: torch.Tensor, s_ptr: torch.Tensor, N2: int, stride_gu_m: int, stride_q_m: int, BLOCK: int) -> None:
    """Cuerpo del custom op: lanza el PTX embebido."""
    _QVAR1(tuple(grid), gu_ptr, q_ptr, s_ptr, N2, stride_gu_m, stride_q_m, BLOCK)
